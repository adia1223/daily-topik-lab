...
const september11Reading: DailyReading = {
...
const september12Reading: DailyReading = {
  id: "2026-09-12-local-care-points",
  date: "2026-09-12",
  title: "지역 돌봄 포인트는 선의만으로 지속될 수 있는가",
  level: "TOPIK II 5-6级",
  topic: "社会 / 经济",
  estimatedTime: "18 分钟",
  korean:
    "고령화가 빠르게 진행되면서 지방자치단체들은 이웃 돌봄 활동에 참여한 주민에게 지역 화폐나 포인트를 지급하는 제도를 도입하고 있다. 혼자 사는 노인의 안부를 확인하거나 병원 동행을 돕고, 아이 돌봄 공백을 메우는 활동을 기록하면 일정한 보상을 받는 방식이다. 이런 제도는 돌봄을 가족 내부의 책임으로만 남겨 두지 않고 지역사회가 함께 나누도록 만든다는 점에서 의미가 있다. 또한 주민 참여가 늘어나면 공공기관이 미처 파악하지 못한 위험 신호를 더 빨리 발견할 수 있다. 그러나 돌봄 포인트가 선의와 보상 사이의 균형을 잃으면 문제가 생길 수 있다. 돌봄 활동이 포인트를 얻기 위한 단순 업무로 변하면 관계의 지속성과 신뢰가 약해진다. 반대로 보상을 지나치게 낮게 책정하면 실제 시간을 들여 참여하는 주민의 노동은 다시 보이지 않는 희생으로 남게 된다. 특히 여성이나 은퇴자에게 돌봄 활동이 자연스럽게 맡겨진다면 기존의 성별 역할과 세대 부담이 반복될 위험도 있다. 따라서 지역 돌봄 포인트는 참여를 유도하는 장치이되 돌봄 노동의 가치를 낮추는 방식으로 운영되어서는 안 된다. 지방자치단체는 활동 시간과 난이도에 맞는 기준을 마련하고, 참여자가 교육과 상담을 받을 수 있도록 지원해야 한다. 또한 포인트 지급 기록을 이용해 어느 동네에 돌봄 수요가 집중되는지 분석하고, 전문 인력과 공공 서비스를 함께 배치해야 한다. 결국 이 제도의 목표는 주민의 선의를 값싸게 이용하는 것이 아니라, 돌봄이 필요한 사람과 돌보는 사람이 모두 지치지 않는 지역 구조를 만드는 데 있다.",
  chinese:
    "随着老龄化快速推进，地方政府正在引入制度：向参与邻里照护活动的居民支付地方货币或积分。确认独居老人的安危、陪同去医院、填补儿童照护空白等活动被记录后，参与者可以获得一定补偿。这一制度的意义在于，它不把照护只留作家庭内部责任，而是让社区共同分担。同时，居民参与增加后，公共机构尚未掌握的风险信号也能更快被发现。然而，如果照护积分失去善意与补偿之间的平衡，就可能产生问题。照护活动若变成只为获得积分的简单任务，关系的持续性与信任会减弱。相反，如果补偿定得过低，投入真实时间的居民劳动又会成为看不见的牺牲。尤其当照护自然地落到女性或退休者身上时，既有性别角色和世代负担也可能被重复。因此，社区照护积分应是引导参与的装置，但不能以降低照护劳动价值的方式运行。地方政府应制定符合活动时间和难度的标准，并支持参与者接受培训和咨询。同时，应利用积分记录分析哪些社区照护需求集中，并配置专业人员和公共服务。归根结底，该制度的目标不是低价利用居民善意，而是建立一种让被照护者和照护者都不会耗尽的社区结构。",
  tokens: [
    { korean: "고령화", reading: "go-ryeong-hwa", meaning: "老龄化", grammar: "명사", note: "文章背景。" },
    { korean: "지방자치단체", reading: "ji-bang ja-chi-dan-che", meaning: "地方政府", grammar: "명사", note: "政策主体。" },
    { korean: "이웃 돌봄", reading: "i-ut dol-bom", meaning: "邻里照护", grammar: "명사구", note: "核心活动。" },
    { korean: "안부를 확인하다", reading: "an-bu-reul hwa-gin-ha-da", meaning: "确认安危", grammar: "동사구", note: "照护任务示例。" },
    { korean: "공백을 메우다", reading: "gong-bae-geul me-u-da", meaning: "填补空白", grammar: "동사구", note: "说明公共服务不足。" },
    { korean: "선의", reading: "seon-ui", meaning: "善意", grammar: "명사", note: "制度依赖的社会资源。" },
    { korean: "균형을 잃다", reading: "gyun-hyeong-eul il-ta", meaning: "失去平衡", grammar: "동사구", note: "问题发生条件。" },
    { korean: "지속성", reading: "ji-sok-seong", meaning: "持续性", grammar: "명사", note: "关系质量指标。" },
    { korean: "보이지 않는 희생", reading: "bo-i-ji an-neun hui-saeng", meaning: "看不见的牺牲", grammar: "명사구", note: "批判低估劳动。" },
    { korean: "돌봄 수요", reading: "dol-bom su-yo", meaning: "照护需求", grammar: "명사구", note: "政策配置依据。" },
  ],
  grammarPoints: [
    { pattern: "V-(으)면서", meaning: "随着……", example: "고령화가 진행되면서 돌봄 제도가 도입되고 있다.", note: "引入社会变化。" },
    { pattern: "V-도록 만들다", meaning: "使……能够……", example: "지역사회가 함께 나누도록 만든다.", note: "说明制度效果。" },
    { pattern: "N이/가 아니라 ... 데 있다", meaning: "不是……而在于……", example: "목표는 선의를 이용하는 것이 아니라 지역 구조를 만드는 데 있다.", note: "结论强化。" },
  ],
  quiz: [
    { question: "지역 돌봄 포인트 제도의积极意义是什么？", answer: "它让照护不再只是家庭责任，而由社区共同承担，并能更早发现公共机构未掌握的风险信号。" },
    { question: "文章指出该制度可能产生哪些问题？", answer: "照护可能变成单纯赚积分的任务，补偿过低也会让居民劳动成为隐形牺牲，还可能重复性别和世代负担。" },
    { question: "作者提出了哪些 운영 방안？", answer: "按时间和难度制定补偿标准，提供培训咨询，并用记录分析照护需求、配置专业人员和公共服务。" },
  ],
  writingDrill: {
    type: "54 题观点写作",
    prompt:
      "지역 돌봄 포인트 제도의 장단점에 대해 쓰십시오. 주민 참여와 돌봄 공백 해소라는 장점, 노동 가치 저평가와 역할 부담 반복 문제를 모두 언급하고, 지속 가능한 운영 방안을 두 가지 이상 제시하십시오.",
    checklist: ["지역 돌봄", "주민 참여", "보상 기준", "돌봄 노동", "공공 서비스"],
    sentenceBank: [
      "지역 돌봄 포인트는 주민이 서로의 어려움을 더 빨리 발견하게 하는 장점이 있다.",
      "그러나 보상이 낮으면 돌봄 노동은 다시 보이지 않는 희생이 될 수 있다.",
      "따라서 지방자치단체는 공정한 기준과 전문 인력 지원을 함께 마련해야 한다.",
    ],
  },
};

const september13Reading: DailyReading = {
  id: "2026-09-13-urban-tree-policy",
  date: "2026-09-13",
  title: "도시 나무 관리는 환경 정책인가 생활 안전 정책인가",
  level: "TOPIK II 5-6级",
  topic: "环境 / 公共政策",
  estimatedTime: "18 分钟",
  korean:
    "기후 변화로 폭염과 집중호우가 잦아지면서 도시의 나무를 어떻게 관리할 것인지가 중요한 정책 과제로 떠오르고 있다. 나무는 그늘을 만들어 보행자의 체감 온도를 낮추고 빗물을 흡수해 도로 침수를 줄이는 역할을 한다. 또한 자동차 소음과 미세먼지를 완화하고 주민에게 휴식 공간을 제공하기 때문에 도시 환경을 개선하는 데 필수적이다. 그러나 나무 관리를 단순히 많이 심는 문제로만 보면 예상치 못한 갈등이 생긴다. 좁은 보도에 큰 나무를 심으면 휠체어와 유모차가 지나가기 어려워지고, 뿌리가 도로를 밀어 올리면 보행 사고가 발생할 수 있다. 태풍 때 가지가 부러지거나 전선과 부딪히는 문제도 주민 안전과 직접 연결된다. 더구나 관리 예산이 부족한 지역에서는 새 나무를 심는 것보다 오래된 나무를 점검하고 치료하는 일이 뒤로 밀리기 쉽다. 따라서 도시 나무 정책은 환경 정책이면서 동시에 생활 안전 정책으로 이해되어야 한다. 행정기관은 지역별 기온, 침수 위험, 보행 환경을 함께 조사해 어디에 어떤 수종을 심을지 결정해야 한다. 주민에게는 나무가 불편을 주는 이유를 신고할 통로를 마련하되, 단순 민원 때문에 건강한 나무가 쉽게 제거되지 않도록 전문가 판단 절차도 필요하다. 결국 도시 나무의 가치는 보기 좋은 녹지를 늘리는 데 그치지 않는다. 나무가 사람의 이동과 안전을 방해하지 않으면서도 더위와 물난리로부터 도시를 보호하도록 관리될 때, 녹색 공간은 실제 생활을 지키는 기반이 될 수 있다.",
  chinese:
    "随着气候变化导致酷暑和强降雨频繁，如何管理城市树木正成为重要政策课题。树木制造阴影，降低行人的体感温度，并吸收雨水以减少道路积水。同时，它还能缓解汽车噪音和细颗粒物，并为居民提供休息空间，因此对改善城市环境必不可少。但是，如果把树木管理只看成多种树的问题，就会产生意外冲突。在狭窄人行道种大树，会让轮椅和婴儿车难以通过；树根顶起道路，也可能造成步行事故。台风时树枝折断或碰到电线的问题，也与居民安全直接相关。再者，在管理预算不足的地区，相比种新树，检查和治疗老树的工作很容易被推后。因此，城市树木政策既应被理解为环境政策，也应被理解为生活安全政策。行政机关应同时调查各地区气温、积水风险和步行环境，再决定在哪里种什么树种。也应为居民提供报告树木造成不便的渠道，但不能因简单投诉而轻易移除健康树木，仍需要专家判断程序。归根结底，城市树木的价值不止于增加好看的绿地。只有当树木既不妨碍人的移动和安全，又能保护城市免受酷暑和水灾影响时，绿色空间才会成为守护现实生活的基础。",
  tokens: [
    { korean: "집중호우", reading: "jip-jung-ho-u", meaning: "强降雨", grammar: "명사", note: "气候风险。" },
    { korean: "정책 과제", reading: "jeong-chaek gwa-je", meaning: "政策课题", grammar: "명사구", note: "文章议题定位。" },
    { korean: "체감 온도", reading: "che-gam on-do", meaning: "体感温度", grammar: "명사구", note: "树荫效益。" },
    { korean: "도로 침수", reading: "do-ro chim-su", meaning: "道路积水", grammar: "명사구", note: "防灾功能。" },
    { korean: "미세먼지", reading: "mi-se-meon-ji", meaning: "细颗粒物", grammar: "명사", note: "环境改善对象。" },
    { korean: "보행 사고", reading: "bo-haeng sa-go", meaning: "步行事故", grammar: "명사구", note: "安全风险。" },
    { korean: "전선과 부딪히다", reading: "jeon-seon-gwa bu-dit-hi-da", meaning: "碰到电线", grammar: "동사구", note: "台风风险。" },
    { korean: "관리 예산", reading: "gwal-li ye-san", meaning: "管理预算", grammar: "명사구", note: "执行条件。" },
    { korean: "수종", reading: "su-jong", meaning: "树种", grammar: "명사", note: "政策选择对象。" },
    { korean: "전문가 판단 절차", reading: "jeon-mun-ga pan-dan jeol-cha", meaning: "专家判断程序", grammar: "명사구", note: "防止随意砍树。" },
  ],
  grammarPoints: [
    { pattern: "V-(으)면서", meaning: "随着……", example: "폭염과 집중호우가 잦아지면서 나무 관리가 중요해졌다.", note: "趋势背景。" },
    { pattern: "V-(으)면", meaning: "如果……", example: "큰 나무를 심으면 통행이 어려워질 수 있다.", note: "条件与后果。" },
    { pattern: "N에 그치지 않다", meaning: "不止于……", example: "가치는 녹지를 늘리는 데 그치지 않는다.", note: "扩展论点范围。" },
  ],
  quiz: [
    { question: "文章认为城市树木有哪些环境功能？", answer: "树木能降温、吸收雨水减少积水、缓解噪音和细颗粒物，并提供休息空间。" },
    { question: "为什么不能只强调多种树？", answer: "树木可能影响轮椅和婴儿车通行，树根可能造成事故，台风中树枝和电线问题也会威胁安全。" },
    { question: "作者认为行政机关应如何制定树木政策？", answer: "应同时调查气温、积水风险和步行环境，选择合适树种，并设置居民 신고 通道和专家判断程序。" },
  ],
  writingDrill: {
    type: "54 题观点写作",
    prompt:
      "도시 나무 관리 정책에 대해 쓰십시오. 더위 완화와 침수 예방이라는 장점, 보행 안전과 관리 예산 문제를 모두 언급하고, 환경과 생활 안전을 함께 고려하는 방안을 두 가지 이상 제시하십시오.",
    checklist: ["도시 나무", "폭염", "침수", "보행 안전", "전문가 판단"],
    sentenceBank: [
      "도시 나무는 폭염과 침수를 줄여 주민의 생활을 보호하는 역할을 한다.",
      "그러나 보행 환경을 고려하지 않으면 나무가 오히려 안전 문제를 만들 수 있다.",
      "따라서 행정기관은 지역별 위험과 전문가 판단을 바탕으로 나무를 관리해야 한다.",
    ],
  },
};

const september14Reading: DailyReading = {
  id: "2026-09-14-office-small-talk-boundary",
  date: "2026-09-14",
  title: "직장 내 사소한 대화는 조직 문화를 바꿀 수 있는가",
  level: "TOPIK II 5-6级",
  topic: "文化 / 职场",
  estimatedTime: "18 分钟",
  korean:
    "재택근무와 유연근무가 확산되면서 직장 동료 사이의 짧은 대화가 줄어들고 있다. 회의는 업무 안건을 중심으로 효율적으로 진행되지만, 점심시간이나 복도에서 자연스럽게 이루어지던 사소한 대화는 쉽게 사라진다. 일부 관리자는 이런 변화가 업무 집중도를 높인다고 평가한다. 불필요한 잡담이 줄면 개인은 방해받지 않고 일을 끝낼 수 있으며, 기록으로 남는 의사소통은 책임 소재를 분명히 하는 데도 도움이 된다. 그러나 사소한 대화가 모두 비효율적인 것은 아니다. 새로운 직원은 공식 문서보다 동료의 짧은 설명을 통해 조직의 분위기와 암묵적인 규칙을 더 빨리 이해한다. 서로의 상황을 가볍게 묻는 과정에서 협업에 필요한 신뢰가 생기고, 작은 문제가 심각한 갈등으로 커지기 전에 조정될 수도 있다. 특히 온라인으로만 일하는 환경에서는 의도하지 않은 침묵이 무관심이나 거절로 해석되기 쉽다. 그렇다고 해서 회사가 친밀한 대화를 강제로 만들 수는 없다. 사적인 이야기를 지나치게 요구하면 직원은 오히려 감정 노동을 해야 한다고 느낄 수 있고, 말수가 적은 사람은 조직에 적응하지 못한다는 평가를 받을 위험도 있다. 따라서 직장 내 대화 문화는 효율과 관계 사이의 균형을 목표로 해야 한다. 조직은 회의 앞뒤에 짧은 확인 시간을 두거나 신규 직원에게 질문할 수 있는 동료를 연결해 줄 수 있다. 동시에 개인의 사생활을 존중하고, 모든 직원이 같은 방식으로 친해져야 한다는 기준을 만들지 말아야 한다. 결국 사소한 대화의 가치는 많은 말을 나누는 데 있는 것이 아니라, 필요한 정보와 신뢰가 자연스럽게 흐를 수 있는 조직 문화를 만드는 데 있다.",
  chinese:
    "随着远程办公和弹性工作扩大，职场同事之间的短对话正在减少。会议以工作议题为中心高效进行，但午餐时间或走廊里自然发生的闲聊很容易消失。一些管理者认为这种变化提高了工作专注度。无用闲聊减少后，个人可以不受打扰地完成工作；留下记录的沟通也有助于明确责任。然而，并不是所有小对话都是低效的。新员工比起正式文件，更能通过同事的简短说明快速理解组织氛围和默认规则。在轻松询问彼此情况的过程中，协作所需的信任会形成，小问题也可能在变成严重冲突前得到调整。尤其在完全线上工作的环境中，无意的沉默很容易被解释为冷漠或拒绝。即便如此，公司也不能强行制造亲密对话。如果过度要求私人话题，员工反而会感到被迫进行情感劳动；话少的人也可能面临“不适应组织”的评价。因此，职场对话文化应以效率和关系之间的平衡为目标。组织可以在会议前后设置短暂确认时间，或为新员工连接可提问的同事。同时，应尊重个人隐私，不应制定所有员工都必须以同一种方式变熟的标准。归根结底，小对话的价值不在于说很多话，而在于建立一种让必要信息和信任自然流动的组织文化。",
  tokens: [
    { korean: "유연근무", reading: "yu-yeon-geun-mu", meaning: "弹性工作", grammar: "명사", note: "工作方式变化。" },
    { korean: "사소한 대화", reading: "sa-so-han dae-hwa", meaning: "小对话、闲聊", grammar: "명사구", note: "核心讨论对象。" },
    { korean: "업무 집중도", reading: "eop-mu jip-jung-do", meaning: "工作专注度", grammar: "명사구", note: "效率视角。" },
    { korean: "책임 소재", reading: "chae-gim so-jae", meaning: "责任归属", grammar: "명사구", note: "记录沟通的优势。" },
    { korean: "암묵적인 규칙", reading: "am-muk-jeo-gin gyu-chik", meaning: "默认规则", grammar: "명사구", note: "新员工需要学习的非正式知识。" },
    { korean: "협업에 필요한 신뢰", reading: "hyeo-beo-be pil-yo-han sin-roe", meaning: "协作所需信任", grammar: "명사구", note: "闲聊的积极作用。" },
    { korean: "무관심", reading: "mu-gwan-sim", meaning: "冷漠", grammar: "명사", note: "线上沉默可能被误解成的态度。" },
    { korean: "감정 노동", reading: "gam-jeong no-dong", meaning: "情感劳动", grammar: "명사구", note: "强制亲密的副作用。" },
    { korean: "사생활을 존중하다", reading: "sa-saeng-hwa-reul jon-jung-ha-da", meaning: "尊重私生活", grammar: "동사구", note: "边界原则。" },
    { korean: "자연스럽게 흐르다", reading: "ja-yeon-seu-reop-ge heu-reu-da", meaning: "自然流动", grammar: "동사구", note: "结论中的理想状态。" },
  ],
  grammarPoints: [
    { pattern: "V-(으)면서", meaning: "随着……", example: "유연근무가 확산되면서 짧은 대화가 줄어들고 있다.", note: "描述背景变化。" },
    { pattern: "V-(으)ㄴ/는 데 도움이 되다", meaning: "有助于……", example: "책임 소재를 분명히 하는 데 도움이 된다.", note: "说明正面作用。" },
    { pattern: "그렇다고 해서 ... 수는 없다", meaning: "即便如此，也不能……", example: "그렇다고 해서 친밀한 대화를 강제로 만들 수는 없다.", note: "承认前文后提出边界。" },
  ],
  quiz: [
    { question: "文章认为短对话减少有什么积极面？", answer: "可以减少打扰、提高专注度，并让通过记录进行的沟通更容易明确责任归属。" },
    { question: "为什么 사소한 대화 对组织也重要？", answer: "它帮助新员工理解组织氛围和默认规则，建立协作信任，并在小问题变成冲突前进行调整。" },
    { question: "作者反对怎样的对话文化？", answer: "反对公司强迫亲密、过度要求私人话题，或用同一种社交方式评价所有员工。" },
  ],
  writingDrill: {
    type: "54 题观点写作",
    prompt:
      "직장 내 사소한 대화가 조직 문화에 미치는 영향에 대해 쓰십시오. 업무 집중과 기록 중심 소통의 장점, 신뢰 형성과 감정 노동 문제를 모두 언급하고, 바람직한 대화 문화를 만들기 위한 방안을 두 가지 이상 제시하십시오.",
    checklist: ["사소한 대화", "업무 집중도", "신뢰", "감정 노동", "사생활 존중"],
    sentenceBank: [
      "사소한 대화는 조직 안에서 필요한 정보와 신뢰가 자연스럽게 흐르도록 돕는다.",
      "그러나 친밀함을 강요하면 직원에게 감정 노동이 될 수 있다.",
      "따라서 조직은 짧은 확인 시간을 마련하되 개인의 사생활과 소통 방식을 존중해야 한다.",
    ],
  },
};

const september15Reading: DailyReading = {
  id: "2026-09-15-ai-complaint-system",
  date: "2026-09-15",
  title: "인공지능 민원 상담은 행정 신뢰를 높일 수 있는가",
  level: "TOPIK II 5-6级",
  topic: "公共政策 / 科技",
  estimatedTime: "19 分钟",
  korean:
    "공공기관이 전화와 창구 중심의 민원 서비스를 줄이고 인공지능 상담 시스템을 도입하는 사례가 늘고 있다. 인공지능 상담은 밤이나 주말에도 기본 정보를 안내할 수 있고, 단순 반복 질문에 빠르게 답해 담당 공무원의 업무 부담을 줄일 수 있다. 민원인은 긴 대기 시간 없이 필요한 서류나 절차를 확인할 수 있으므로 행정 서비스의 접근성이 높아진다. 특히 교통, 세금, 복지처럼 규정이 복잡한 분야에서는 질문을 단계별로 정리해 주는 기능이 도움이 될 수 있다. 그러나 상담 속도가 빨라진다고 해서 행정 신뢰가 자동으로 높아지는 것은 아니다. 민원은 단순한 정보 요청만이 아니라 개인의 생활 문제와 권리 구제 요구를 포함하는 경우가 많다. 인공지능이 예외 상황을 충분히 이해하지 못하거나 잘못된 답변을 제공하면, 민원인은 어느 기관에 책임을 물어야 하는지 알기 어렵다. 또한 상담 기록이 어떻게 저장되고 학습 데이터로 사용되는지 불분명하면 개인정보 침해에 대한 불안도 커질 수 있다. 디지털 기기에 익숙하지 않은 노인이나 장애인이 상담 시스템을 이용하기 어렵다면, 편의를 위한 기술이 오히려 행정 장벽을 높일 가능성도 있다. 따라서 인공지능 민원 상담은 사람을 대체하는 창구가 아니라 행정 서비스를 보조하는 첫 단계로 운영되어야 한다. 공공기관은 답변의 출처와 한계를 명확히 표시하고, 권리나 금전과 관련된 민원은 담당자에게 즉시 연결되는 절차를 마련해야 한다. 또한 상담 기록의 보관 기간과 활용 범위를 시민에게 공개하고, 오류를 정정할 수 있는 통로를 제공해야 한다. 결국 행정 신뢰는 빠른 응답만으로 만들어지지 않는다. 시민이 자신의 문제가 정확히 이해되고 책임 있게 처리된다고 느낄 때, 인공지능 상담은 행정 신뢰를 높이는 도구가 될 수 있다.",
  chinese:
    "公共机构减少以电话和窗口为中心的民愿服务，并引入人工智能咨询系统的案例正在增加。AI咨询可以在夜间或周末提供基本信息，也能快速回答重复性问题，从而降低负责公务员的工作负担。民愿人无需长时间等待就能确认所需文件或流程，因此行政服务的可及性会提高。尤其在交通、税务、福利等规定复杂的领域，将问题按步骤整理的功能可能很有帮助。然而，咨询速度变快并不意味着行政信任会自动提高。民愿往往不只是单纯的信息请求，还包含个人生活问题和权利救济诉求。如果AI无法充分理解例外情况，或提供错误回答，民愿人很难知道应向哪个机构追责。此外，如果咨询记录如何保存、如何用于学习数据并不透明，个人信息侵害的不安也会增加。如果不熟悉数字设备的老年人或残障人士难以使用咨询系统，为了便利而引入的技术反而可能提高行政门槛。因此，AI民愿咨询不应作为替代人的窗口，而应作为辅助行政服务的第一阶段来运营。公共机构应明确标示回答来源和局限；涉及权利或金钱的民愿，应设置立即连接负责人处理的程序。同时，应向市民公开咨询记录的保存期限和使用范围，并提供纠正错误的渠道。归根结底，行政信任不是只靠快速回应建立的。只有当市民感到自己的问题被准确理解并被负责任地处理时，AI咨询才可能成为提高行政信任的工具。",
  tokens: [
    { korean: "공공기관", reading: "gong-gong-gi-gwan", meaning: "公共机构", grammar: "명사", note: "政策执行主体。" },
    { korean: "민원 서비스", reading: "min-won seo-bi-seu", meaning: "民愿服务、政务咨询服务", grammar: "명사구", note: "文章讨论对象。" },
    { korean: "인공지능 상담 시스템", reading: "in-gong-ji-neung sang-dam si-seu-tem", meaning: "人工智能咨询系统", grammar: "명사구", note: "核心技术。" },
    { korean: "업무 부담을 줄이다", reading: "eop-mu bu-da-meul ju-ri-da", meaning: "减轻工作负担", grammar: "동사구", note: "引入系统的行政理由。" },
    { korean: "접근성", reading: "jeop-geun-seong", meaning: "可及性", grammar: "명사", note: "公共服务评价指标。" },
    { korean: "단계별로 정리하다", reading: "dan-gye-byeol-lo jeong-ri-ha-da", meaning: "按步骤整理", grammar: "동사구", note: "AI功能优势。" },
    { korean: "권리 구제", reading: "gwon-ri gu-je", meaning: "权利救济", grammar: "명사구", note: "民愿中的高风险事项。" },
    { korean: "책임을 묻다", reading: "chae-gi-meul mut-da", meaning: "追究责任", grammar: "동사구", note: "错误回答后的问题。" },
    { korean: "개인정보 침해", reading: "gae-in-jeong-bo chim-hae", meaning: "个人信息侵害", grammar: "명사구", note: "数据治理风险。" },
    { korean: "행정 장벽", reading: "haeng-jeong jang-byeok", meaning: "行政门槛", grammar: "명사구", note: "数字弱势群体可能遇到的问题。" },
    { korean: "출처와 한계", reading: "chul-cheo-wa han-gye", meaning: "来源和局限", grammar: "명사구", note: "透明性要求。" },
    { korean: "보관 기간", reading: "bo-gwan gi-gan", meaning: "保存期限", grammar: "명사구", note: "数据管理条件。" },
    { korean: "책임 있게 처리되다", reading: "chae-gim it-ge cheo-ri-doe-da", meaning: "被负责任地处理", grammar: "피동", note: "行政信任形成条件。" },
  ],
  grammarPoints: [
    { pattern: "V-는 사례가 늘고 있다", meaning: "……的案例正在增加", example: "인공지능 상담 시스템을 도입하는 사례가 늘고 있다.", note: "引出社会趋势。" },
    { pattern: "V-다고 해서 ... 것은 아니다", meaning: "并非因为……就……", example: "상담 속도가 빨라진다고 해서 신뢰가 자동으로 높아지는 것은 아니다.", note: "高级论证中的反驳结构。" },
    { pattern: "V-(으)면", meaning: "如果……", example: "기기에 익숙하지 않다면 행정 장벽이 높아질 수 있다.", note: "说明条件和风险。" },
    { pattern: "N이/가 아니라 ... 로/으로", meaning: "不是……而是作为……", example: "사람을 대체하는 창구가 아니라 서비스를 보조하는 첫 단계로 운영되어야 한다.", note: "明确制度定位。" },
  ],
  quiz: [
    { question: "文章认为 AI 민원 상담 的主要优点是什么？", answer: "它可以在夜间和周末提供基本信息，快速回答重复问题，减轻公务员负担，并提高行政服务可及性。" },
    { question: "为什么快速咨询不一定带来行政信任？", answer: "民愿常涉及权利救济和个人生活问题，AI可能无法理解例外情况或给出错误回答，责任归属和隐私使用也可能不透明。" },
    { question: "作者提出了哪些 운영 원칙？", answer: "应标示回答来源和局限，高风险民愿立即转人工，公开记录保存和使用范围，并提供纠错通道。" },
  ],
  writingDrill: {
    type: "54 题观点写作",
    prompt:
      "인공지능 민원 상담 시스템이 행정 서비스에 미치는 영향에 대해 쓰십시오. 접근성 향상과 업무 부담 감소라는 장점, 잘못된 답변과 개인정보 침해 문제를 모두 언급하고, 신뢰를 높이기 위한 운영 방안을 두 가지 이상 제시하십시오.",
    checklist: ["인공지능 상담", "행정 신뢰", "접근성", "개인정보", "책임 절차"],
    sentenceBank: [
      "인공지능 민원 상담은 시민이 필요한 정보를 더 빠르게 확인하도록 도울 수 있다.",
      "그러나 잘못된 답변의 책임과 개인정보 활용 기준이 불분명하면 행정 신뢰는 오히려 약해진다.",
      "따라서 공공기관은 답변의 한계를 공개하고 중요한 민원은 담당자에게 즉시 연결해야 한다.",
    ],
  },
};

const september16Reading: DailyReading = {
  id: "2026-09-16-right-to-repair",
  date: "2026-09-16",
  title: "수리할 권리는 소비 문화를 바꿀 수 있는가",
  level: "TOPIK II 5-6级",
  topic: "环境 / 经济",
  estimatedTime: "19 分钟",
  korean:
    "스마트폰과 노트북, 가전제품의 교체 주기가 짧아지면서 고장 난 물건을 고쳐 쓰기보다 새로 사는 소비 방식이 익숙해지고 있다. 제품 안에는 여전히 사용할 수 있는 부품이 남아 있어도, 수리 비용이 비싸거나 부품을 구하기 어려우면 소비자는 교체를 선택하게 된다. 이에 따라 최근에는 소비자가 제품을 직접 또는 독립 수리점에서 고칠 수 있도록 제조사가 부품과 설명서를 제공해야 한다는 수리할 권리 논의가 확산되고 있다. 이 권리가 보장되면 전자 폐기물을 줄이고 자원을 더 오래 사용할 수 있으며, 지역 수리업체의 일자리도 늘어날 수 있다. 그러나 수리할 권리가 곧바로 친환경 소비를 보장하는 것은 아니다. 제품 구조가 지나치게 복잡하거나 접착제로 단단히 고정되어 있으면, 부품을 제공해도 실제 수리는 어렵다. 또한 안전과 품질을 이유로 제조사가 모든 수리를 통제하려 한다면 독립 수리점은 시장에 진입하기 어렵고, 소비자는 여전히 높은 비용을 부담하게 된다. 반대로 검증되지 않은 부품이 무분별하게 사용되면 사고가 발생하거나 제품 수명이 오히려 짧아질 수도 있다. 따라서 수리할 권리는 단순히 부품 판매를 허용하는 수준에 머물러서는 안 된다. 정부는 제품 설계 단계에서부터 분해와 수리가 가능하도록 기준을 만들고, 수리 난이도와 예상 비용을 소비자가 구매 전에 알 수 있게 해야 한다. 제조사는 안전에 관한 핵심 정보는 명확히 제공하되, 독립 수리업체가 공정하게 경쟁할 수 있는 접근권도 보장해야 한다. 소비자 역시 무조건 새 제품을 사기보다 수리 가능성과 사용 기간을 구매 기준으로 삼는 습관을 가져야 한다. 결국 수리할 권리의 목적은 낡은 물건을 오래 붙잡아 두는 데 있는 것이 아니라, 제품의 가치가 쉽게 버려지지 않는 소비 문화를 만드는 데 있다.",
  chinese:
    "随着智能手机、笔记本电脑和家电的更换周期变短，人们越来越习惯于购买新品，而不是修好故障物品继续使用。即使产品内部仍有可以使用的零件，只要维修费用昂贵或零件难以获得，消费者就会选择更换。因此，近来关于“维修权”的讨论正在扩大：制造商应提供零件和说明书，使消费者能够自行维修或通过独立维修店维修产品。如果这一权利得到保障，就能减少电子废弃物，使资源使用更久，也可能增加本地维修业的就业。然而，维修权并不会立即保证环保消费。如果产品结构过于复杂，或被胶水牢牢固定，即使提供零件，实际维修也很困难。此外，如果制造商以安全和质量为由控制所有维修，独立维修店就难以进入市场，消费者仍会承担高费用。相反，如果未经验证的零件被无序使用，也可能发生事故，或反而缩短产品寿命。因此，维修权不能停留在允许销售零件的程度。政府应从产品设计阶段开始制定便于拆解和维修的标准，并让消费者在购买前知道维修难度和预期费用。制造商应明确提供与安全有关的核心信息，同时保障独立维修商公平竞争的访问权。消费者也应形成一种习惯：不一味购买新品，而把可维修性和使用期限作为购买标准。归根结底，维修权的目的不是抓住旧物不放，而是建立一种产品价值不被轻易丢弃的消费文化。",
  tokens: [
    { korean: "교체 주기", reading: "gyo-che ju-gi", meaning: "更换周期", grammar: "명사구", note: "消费模式变化指标。" },
    { korean: "고쳐 쓰다", reading: "go-cheo sseu-da", meaning: "修好后继续使用", grammar: "동사구", note: "与购买新品形成对比。" },
    { korean: "수리 비용", reading: "su-ri bi-yong", meaning: "维修费用", grammar: "명사구", note: "影响选择的经济因素。" },
    { korean: "수리할 권리", reading: "su-ri-hal gwon-ri", meaning: "维修权", grammar: "명사구", note: "文章核心概念。" },
    { korean: "전자 폐기물", reading: "jeon-ja pye-gi-mul", meaning: "电子废弃物", grammar: "명사구", note: "环境问题。" },
    { korean: "제품 구조", reading: "je-pum gu-jo", meaning: "产品结构", grammar: "명사구", note: "实际可维修性的条件。" },
    { korean: "접착제로 고정되다", reading: "jeop-chak-je-ro go-jeong-doe-da", meaning: "被胶水固定", grammar: "피동", note: "说明拆解困难。" },
    { korean: "독립 수리점", reading: "dong-nip su-ri-jeom", meaning: "独立维修店", grammar: "명사구", note: "市场参与者。" },
    { korean: "진입하기 어렵다", reading: "jin-ip-ha-gi e-ryeop-da", meaning: "难以进入", grammar: "형용사구", note: "市场限制表达。" },
    { korean: "무분별하게 사용되다", reading: "mu-bun-byeol-ha-ge sa-yong-doe-da", meaning: "被无序使用", grammar: "피동", note: "不合格零件风险。" },
    { korean: "분해와 수리", reading: "bun-hae-wa su-ri", meaning: "拆解和维修", grammar: "명사구", note: "设计标准。" },
    { korean: "접근권", reading: "jeop-geun-gwon", meaning: "访问权、接触权", grammar: "명사", note: "独立维修商需要的条件。" },
    { korean: "구매 기준", reading: "gu-mae gi-jun", meaning: "购买标准", grammar: "명사구", note: "消费者行为改变。" },
  ],
  grammarPoints: [
    { pattern: "V-(으)면서", meaning: "随着……", example: "교체 주기가 짧아지면서 새로 사는 방식이 익숙해지고 있다.", note: "引出社会趋势。" },
    { pattern: "V-도록", meaning: "为了使……能够……", example: "소비자가 고칠 수 있도록 부품과 설명서를 제공해야 한다.", note: "说明制度目的。" },
    { pattern: "V-아/어도", meaning: "即使……也……", example: "부품을 제공해도 실제 수리는 어렵다.", note: "表达条件不足。" },
    { pattern: "N에 머물러서는 안 된다", meaning: "不能停留在……", example: "부품 판매를 허용하는 수준에 머물러서는 안 된다.", note: "提出更高政策要求。" },
  ],
  quiz: [
    { question: "文章认为 수리할 권리 的主要意义是什么？", answer: "它可以减少电子废弃物、延长资源使用时间，并为本地独立维修行业创造就业机会。" },
    { question: "为什么维修权不一定马上带来环保消费？", answer: "产品可能难以拆解，制造商可能控制维修市场，未经验证零件也可能带来事故或缩短寿命。" },
    { question: "作者认为政府、制造商和消费者分别应如何行动？", answer: "政府应制定可拆解和维修标准并公开维修难度费用；制造商应提供安全信息和公平访问权；消费者应把可维修性纳入购买标准。" },
  ],
  writingDrill: {
    type: "54 题观点写作",
    prompt:
      "수리할 권리가 소비 문화와 환경에 미치는 영향에 대해 쓰십시오. 전자 폐기물 감소와 지역 수리업 활성화라는 장점, 안전 문제와 제조사의 시장 통제 문제를 모두 언급하고, 제도를 효과적으로 운영하기 위한 방안을 두 가지 이상 제시하십시오.",
    checklist: ["수리할 권리", "전자 폐기물", "수리 비용", "독립 수리점", "구매 기준"],
    sentenceBank: [
      "수리할 권리는 제품을 더 오래 사용하게 하여 전자 폐기물을 줄이는 데 도움이 된다.",
      "그러나 안전 기준과 부품 품질이 불분명하면 소비자 피해가 발생할 수 있다.",
      "따라서 정부는 수리 가능성 기준을 마련하고 제조사는 필요한 정보를 공정하게 제공해야 한다.",
    ],
  },
};

const september17Reading: DailyReading = {
  id: "2026-09-17-community-learning-gap",
  date: "2026-09-17",
  title: "마을 학습 공간은 교육 격차를 줄일 수 있는가",
  level: "TOPIK II 5-6级",
  topic: "教育 / 社会",
  estimatedTime: "19 分钟",
  korean:
    "방과 후 학원에 갈 수 있는 학생과 그렇지 못한 학생 사이의 학습 격차가 커지면서, 지방자치단체와 학교가 함께 운영하는 마을 학습 공간에 대한 관심이 높아지고 있다. 마을 학습 공간은 도서관, 주민센터, 빈 교실 등을 활용해 학생이 무료로 공부하고 질문할 수 있도록 만든 장소이다. 이곳에서는 대학생 멘토나 은퇴 교사가 숙제를 도와주고, 온라인 수업을 들을 수 있는 기기와 인터넷도 제공된다. 가정의 경제력이나 부모의 시간에 따라 학습 기회가 달라지는 상황에서 이런 공간은 학생에게 최소한의 학습 안전망이 될 수 있다. 또한 학교 밖 어른과 만나는 경험은 학생이 진로를 넓게 생각하도록 돕기도 한다. 그러나 공간을 만드는 것만으로 교육 격차가 줄어드는 것은 아니다. 운영 시간이 짧거나 교통이 불편하면 정작 도움이 필요한 학생이 꾸준히 이용하기 어렵다. 멘토가 자주 바뀌면 학생의 학습 상태를 지속적으로 파악하기 힘들고, 단순히 숙제를 대신 해결해 주는 방식으로 흐를 위험도 있다. 더구나 마을 학습 공간이 학교 수업의 부족한 부분을 보완한다는 이유로 정규 교육의 책임이 지역 자원봉사자에게 떠넘겨져서는 안 된다. 따라서 이 제도는 복지 사업과 교육 정책이 함께 설계되어야 한다. 지방자치단체는 안전한 이동 수단과 저녁 운영 시간을 마련하고, 학교는 학생별 학습 정보를 필요한 범위 안에서 공유해야 한다. 멘토에게는 교육 방법과 아동 보호에 관한 기본 훈련을 제공해야 한다. 결국 마을 학습 공간의 가치는 공부할 장소를 하나 더 만드는 데 있는 것이 아니라, 학생이 자신의 조건 때문에 배움에서 밀려나지 않도록 지역 전체가 책임을 나누는 데 있다.",
  chinese:
    "随着能去课后补习班的学生与不能去的学生之间学习差距扩大，地方政府和学校共同运营的社区学习空间受到关注。社区学习空间是利用图书馆、居民中心、空教室等，让学生可以免费学习和提问的场所。在这里，大学生导师或退休教师会帮助学生完成作业，也会提供能听线上课程的设备和网络。在学习机会因家庭经济能力或父母时间而不同的情况下，这类空间可以成为学生最低限度的学习安全网。此外，与校外成年人接触的经历，也能帮助学生更广泛地思考未来道路。然而，仅仅建成空间并不会减少教育差距。如果开放时间短或交通不便，真正需要帮助的学生很难持续使用。导师频繁更换，也难以持续掌握学生学习状态；服务还可能流向替学生完成作业的方式。再者，不能因为社区学习空间补足学校教学不足，就把正规教育责任转嫁给地区志愿者。因此，该制度应由福利项目和教育政策共同设计。地方政府应提供安全交通方式和晚间运营时间，学校则应在必要范围内共享学生学习信息。导师也应接受教学方法和儿童保护方面的基本培训。归根结底，社区学习空间的价值不在于再增加一个学习场所，而在于让整个地区共同分担责任，使学生不因自身条件而被学习排除在外。",
  tokens: [
    { korean: "학습 격차", reading: "hak-seup gyeok-cha", meaning: "学习差距", grammar: "명사구", note: "文章核心问题。" },
    { korean: "지방자치단체", reading: "ji-bang ja-chi-dan-che", meaning: "地方政府", grammar: "명사", note: "政策运营主体之一。" },
    { korean: "마을 학습 공간", reading: "ma-eul hak-seup gong-gan", meaning: "社区学习空间", grammar: "명사구", note: "核心制度。" },
    { korean: "무료로", reading: "mu-ryo-ro", meaning: "免费地", grammar: "부사", note: "说明公共性。" },
    { korean: "멘토", reading: "men-to", meaning: "导师", grammar: "명사", note: "支持学习的人力资源。" },
    { korean: "학습 안전망", reading: "hak-seup an-jeon-mang", meaning: "学习安全网", grammar: "명사구", note: "制度价值。" },
    { korean: "진로", reading: "jin-ro", meaning: "升学/职业道路", grammar: "명사", note: "学习支持的扩展效果。" },
    { korean: "꾸준히 이용하다", reading: "kku-jun-hi i-yong-ha-da", meaning: "持续使用", grammar: "동사구", note: "政策有效性的条件。" },
    { korean: "지속적으로 파악하다", reading: "ji-sok-jeo-geu-ro pa-ak-ha-da", meaning: "持续掌握", grammar: "동사구", note: "导师稳定性的作用。" },
    { korean: "떠넘겨지다", reading: "tteo-neom-gyeo-ji-da", meaning: "被转嫁", grammar: "피동", note: "责任转移风险。" },
    { korean: "복지 사업", reading: "bok-ji sa-eop", meaning: "福利项目", grammar: "명사구", note: "需要协同的政策领域。" },
    { korean: "아동 보호", reading: "a-dong bo-ho", meaning: "儿童保护", grammar: "명사구", note: "导师培训内容。" },
    { korean: "책임을 나누다", reading: "chae-gi-meul na-nu-da", meaning: "分担责任", grammar: "동사구", note: "结论目标。" },
  ],
  grammarPoints: [
    { pattern: "V-(으)면서", meaning: "随着……", example: "학습 격차가 커지면서 관심이 높아지고 있다.", note: "引出社会背景。" },
    { pattern: "V-도록 만들다", meaning: "使……能够……", example: "학생이 무료로 공부하고 질문할 수 있도록 만든 장소이다.", note: "说明制度目的。" },
    { pattern: "V-는 것만으로 ... 것은 아니다", meaning: "仅靠……并不……", example: "공간을 만드는 것만으로 교육 격차가 줄어드는 것은 아니다.", note: "反驳单一措施万能论。" },
    { pattern: "N에 있는 것이 아니라 ... 데 있다", meaning: "不在于……而在于……", example: "가치는 장소를 만드는 데 있는 것이 아니라 책임을 나누는 데 있다.", note: "高级结论结构。" },
  ],
  quiz: [
    { question: "文章认为 마을 학습 공간 的积极作用是什么？", answer: "它能为缺少课外资源的学生提供免费学习、提问、设备和网络支持，成为最低限度的学习安全网。" },
    { question: "为什么仅仅建设空间不能减少教育差距？", answer: "如果开放时间短、交通不便、导师频繁更换，真正需要帮助的学生难以持续使用，学习状态也难以被持续掌握。" },
    { question: "作者认为该制度应如何运营？", answer: "应由福利和教育政策共同设计，提供安全交通和晚间运营，学校适度共享学习信息，并培训导师的教学和儿童保护能力。" },
  ],
  writingDrill: {
    type: "54 题观点写作",
    prompt:
      "마을 학습 공간이 교육 격차 해소에 미치는 영향에 대해 쓰십시오. 학습 안전망과 진로 탐색이라는 장점, 운영 시간과 멘토 안정성 문제를 모두 언급하고, 효과적인 운영 방안을 두 가지 이상 제시하십시오.",
    checklist: ["마을 학습 공간", "교육 격차", "학습 안전망", "멘토", "지역 책임"],
    sentenceBank: [
      "마을 학습 공간은 경제적 조건 때문에 학습 기회를 얻기 어려운 학생에게 안전망이 될 수 있다.",
      "그러나 운영 시간이 짧거나 멘토가 자주 바뀌면 지속적인 학습 지원이 어렵다.",
      "따라서 지방자치단체와 학교는 교통, 운영 시간, 멘토 교육을 함께 설계해야 한다.",
    ],
  },
};

const september18Reading: DailyReading = {
  id: "2026-09-18-public-data-innovation",
  date: "2026-09-18",
  title: "공공 데이터 개방은 혁신을 보장하는가",
  level: "TOPIK II 5-6级",
  topic: "科技 / 公共政策",
  estimatedTime: "20 分钟",
  korean:
    "정부와 공공기관이 보유한 교통, 환경, 복지 데이터를 시민과 기업에 공개하는 정책이 확대되고 있다. 공공 데이터가 충분히 개방되면 민간 기업은 새로운 서비스를 개발할 수 있고, 연구자는 사회 문제를 더 정확하게 분석할 수 있다. 시민도 자신이 사는 지역의 미세 먼지나 예산 사용 현황을 직접 확인하며 행정에 참여할 수 있다. 이런 점에서 데이터 개방은 정보의 주인을 기관에서 시민으로 돌려주는 과정이라고 평가된다. 그러나 파일을 인터넷에 올리는 것만으로 혁신이 생기는 것은 아니다. 기관마다 자료의 형식과 분류 기준이 다르면 여러 데이터를 함께 분석하기 어렵고, 갱신이 늦거나 오류가 많으면 이를 활용한 서비스의 신뢰도도 떨어진다. 개인정보를 지운다는 이유로 핵심 항목을 지나치게 삭제하면 자료의 가치가 낮아지는 반면, 익명 처리가 충분하지 않으면 여러 정보를 결합하는 과정에서 개인이 다시 식별될 위험이 있다. 데이터 활용 능력이 높은 대기업과 일부 전문가만 혜택을 얻는 문제도 무시하기 어렵다. 따라서 공공 데이터 정책의 성과는 공개된 파일의 수보다 실제로 해결된 문제를 기준으로 평가해야 한다. 정부는 기관별 자료 형식을 표준화하고 오류 수정과 갱신 일정을 공개해야 한다. 또한 시민 단체와 소규모 기업이 필요한 데이터를 쉽게 찾고 활용하도록 교육과 기술 지원을 제공할 필요가 있다. 민감한 정보는 독립적인 심의를 거쳐 공개 범위를 정하고, 문제가 발견되면 이용을 중단하거나 수정할 절차도 마련해야 한다. 결국 데이터 개방의 목적은 자료를 많이 쌓아 두는 데 있지 않고, 신뢰할 수 있는 정보를 누구나 공정하게 활용하도록 만드는 데 있다.",
  chinese:
    "政府和公共机构正在扩大向市民与企业开放交通、环境、福利数据的政策。公共数据若得到充分开放，民营企业可以开发新服务，研究者也能更准确地分析社会问题。市民还能亲自确认居住地区的细颗粒物状况或预算使用情况，参与行政事务。从这一点看，数据开放被评价为将信息的主人从机构归还给市民的过程。然而，仅把文件上传到网络并不会产生创新。如果各机构的数据格式和分类标准不同，多种数据就难以合并分析；如果更新迟缓或错误较多，利用这些数据开发的服务可信度也会下降。以删除个人信息为由过度删减核心项目，会降低数据价值；相反，匿名处理不充分，又可能在多种信息结合时重新识别个人。只有数据应用能力强的大企业和少数专家获益的问题也不可忽视。因此，公共数据政策的成效应以实际解决的问题，而非公开文件的数量来评价。政府应统一各机构的数据格式，并公开纠错和更新日程。还需要提供教育与技术支持，使市民团体和小企业能轻松找到并使用所需数据。敏感信息应经独立审议确定公开范围，并建立发现问题后暂停使用或修正的程序。归根结底，数据开放的目的不在于大量堆积资料，而在于让任何人都能公平使用可信的信息。",
  tokens: [
    { korean: "보유하다", reading: "bo-yu-ha-da", meaning: "持有、拥有", grammar: "동사", note: "说明公共机构掌握数据。" },
    { korean: "개방되다", reading: "gae-bang-doe-da", meaning: "被开放", grammar: "피동", note: "文章核心政策动作。" },
    { korean: "현황", reading: "hyeon-hwang", meaning: "现状、情况", grammar: "명사", note: "常见于政策和统计文本。" },
    { korean: "행정에 참여하다", reading: "haeng-jeong-e cham-yeo-ha-da", meaning: "参与行政事务", grammar: "동사구", note: "说明数据开放的民主价值。" },
    { korean: "분류 기준", reading: "bul-lyu gi-jun", meaning: "分类标准", grammar: "명사구", note: "数据互通的条件。" },
    { korean: "갱신", reading: "gaeng-sin", meaning: "更新", grammar: "명사", note: "衡量数据时效性的词。" },
    { korean: "신뢰도", reading: "sil-loe-do", meaning: "可信度", grammar: "명사", note: "服务质量评价指标。" },
    { korean: "익명 처리", reading: "ing-myeong cheo-ri", meaning: "匿名处理", grammar: "명사구", note: "隐私保护手段。" },
    { korean: "다시 식별되다", reading: "da-si sik-byeol-doe-da", meaning: "被重新识别", grammar: "피동", note: "数据结合带来的隐私风险。" },
    { korean: "혜택을 얻다", reading: "hye-tae-geul eot-da", meaning: "获得益处", grammar: "동사구", note: "说明利益分配。" },
    { korean: "표준화하다", reading: "pyo-jun-hwa-ha-da", meaning: "标准化", grammar: "동사", note: "政府应采取的措施。" },
    { korean: "공개 범위", reading: "gong-gae beom-wi", meaning: "公开范围", grammar: "명사구", note: "敏感信息治理边界。" },
    { korean: "절차를 마련하다", reading: "jeol-cha-reul ma-ryeon-ha-da", meaning: "建立程序", grammar: "동사구", note: "政策建议常用搭配。" },
  ],
  grammarPoints: [
    { pattern: "V-(으)면", meaning: "如果……", example: "공공 데이터가 충분히 개방되면 새로운 서비스를 개발할 수 있다.", note: "提出政策成立时的预期效果。" },
    { pattern: "V-는 것만으로 ... 것은 아니다", meaning: "仅靠……并不……", example: "파일을 올리는 것만으로 혁신이 생기는 것은 아니다.", note: "反驳把公开数量等同于政策成果的观点。" },
    { pattern: "N인 반면", meaning: "一方面……，而另一方面……", example: "지나치게 삭제하면 가치가 낮아지는 반면 익명 처리가 부족하면 위험이 커진다.", note: "对照数据价值与隐私保护的两难。" },
    { pattern: "N보다 ... 을/를 기준으로", meaning: "与其以……，不如以……为标准", example: "파일의 수보다 실제로 해결된 문제를 기준으로 평가해야 한다.", note: "用于提出评价标准。" },
  ],
  quiz: [
    { question: "文章认为公共数据开放可以带来哪些积极作用？", answer: "它能帮助企业开发服务、研究者分析社会问题，并让市民查询环境和预算信息、参与行政。" },
    { question: "为什么把文件上传到网络并不足以产生创新？", answer: "格式和分类标准不一致会妨碍合并分析，更新迟缓与错误会降低可信度，隐私处理也可能在数据价值和重新识别风险之间失衡。" },
    { question: "作者提出了哪些改善公共数据政策的措施？", answer: "统一数据格式，公开纠错和更新日程，为市民团体与小企业提供教育和技术支持，并通过独立审议及暂停、修正程序管理敏感信息。" },
  ],
  writingDrill: {
    type: "54 题观点写作",
    prompt:
      "공공 데이터 개방이 사회 혁신에 미치는 영향에 대해 쓰십시오. 새로운 서비스와 시민 참여라는 장점, 자료 품질과 개인정보 보호 문제를 모두 언급하고, 공정한 데이터 활용을 위한 방안을 두 가지 이상 제시하십시오.",
    checklist: ["공공 데이터", "시민 참여", "자료 품질", "개인정보", "공정한 활용"],
    sentenceBank: [
      "공공 데이터는 기업과 시민이 사회 문제를 새롭게 해결할 수 있는 기반이 된다.",
      "그러나 자료의 형식과 품질이 일정하지 않으면 공개된 데이터의 실질적 가치는 낮아진다.",
      "따라서 정부는 표준과 갱신 절차를 마련하고 정보 활용 능력이 낮은 집단도 지원해야 한다.",
    ],
  },
};

const september19Reading: DailyReading = {
  id: "2026-09-19-heat-shelter-network",
  date: "2026-09-19",
  title: "폭염 쉼터는 도시의 안전망이 될 수 있는가",
  level: "TOPIK II 5-6级",
  topic: "环境 / 社会",
  estimatedTime: "20 分钟",
  korean:
    "여름철 폭염이 길어지면서 지방자치단체는 경로당, 주민센터, 은행 등을 폭염 쉼터로 지정하고 있다. 냉방비를 부담하기 어렵거나 집 안 온도가 높은 시민에게 쉼터는 더위를 피할 수 있는 중요한 공간이다. 특히 혼자 사는 노인이나 야외 노동자처럼 온열 질환에 취약한 사람에게 가까운 쉼터는 생명을 지키는 안전망이 될 수 있다. 쉼터를 중심으로 건강 상태를 확인하고 물과 응급 정보를 제공한다면 복지 서비스와 재난 대응을 연결하는 효과도 기대할 수 있다. 그러나 쉼터의 수가 많다고 해서 시민이 실제로 보호받는 것은 아니다. 지도에는 운영 중이라고 표시되어 있어도 주말에 문을 닫거나, 계단 때문에 이동이 불편한 사람이 들어갈 수 없는 경우가 있다. 가장 더운 시간에 야외에서 일하는 노동자는 근무지를 벗어나기 어렵고, 돌봄이 필요한 시민은 쉼터까지 혼자 이동하지 못하기도 한다. 쉼터 이용을 개인의 선택으로만 남겨 두면 위험에 더 많이 노출된 사람이 오히려 지원에서 제외될 수 있다. 따라서 폭염 대책은 건물의 개수보다 접근성과 연결성을 중심으로 설계되어야 한다. 지방자치단체는 실시간 운영 정보를 제공하고, 대중교통 정류장과 노동 현장 주변에 임시 휴식 공간을 마련해야 한다. 보건소와 복지 기관은 고위험 가구에 먼저 연락해 이동 수단이나 방문 냉방을 지원할 필요가 있다. 사업주에게도 충분한 휴식 시간과 물을 제공할 책임을 명확히 부과해야 한다. 결국 폭염 쉼터의 역할은 시원한 방을 열어 두는 데 그치지 않는다. 위험한 사람을 미리 찾아내고 필요한 지원과 연결할 때 비로소 도시의 기후 안전망으로 기능할 수 있다.",
  chinese:
    "随着夏季高温天气持续时间变长，地方政府正把敬老堂、居民中心、银行等指定为高温避暑点。对于难以承担制冷费用或家中温度较高的市民而言，避暑点是躲避酷暑的重要空间。尤其对独居老人、户外劳动者等容易患热相关疾病的人来说，附近的避暑点可以成为保护生命的安全网。如果还能以避暑点为中心确认健康状况，提供饮用水和急救信息，也有望把福利服务与灾害应对连接起来。然而，避暑点数量多，并不意味着市民真的受到保护。地图上即使显示正在开放，也可能周末关门，或因楼梯导致行动不便者无法进入。最炎热时段在户外工作的人很难离开工作地点，需要照护的市民也可能无法独自前往。若把使用避暑点完全留给个人选择，暴露于更高风险的人反而可能被排除在支援之外。因此，高温对策应以可达性和衔接性，而非建筑数量为中心来设计。地方政府应提供实时运营信息，并在公交站和劳动现场附近设置临时休息空间。保健所和福利机构有必要主动联系高风险家庭，提供交通或上门制冷支援。还应明确要求雇主承担提供充分休息时间和饮用水的责任。归根结底，避暑点的作用不能只停留在开放凉爽房间；只有提前找到处于危险中的人，并把他们连接到所需支援，才能真正成为城市的气候安全网。",
  tokens: [
    { korean: "폭염", reading: "po-geom", meaning: "酷暑、高温热浪", grammar: "명사", note: "文章的灾害背景。" },
    { korean: "폭염 쉼터", reading: "po-geom swim-teo", meaning: "高温避暑点", grammar: "명사구", note: "文章核心公共设施。" },
    { korean: "냉방비를 부담하다", reading: "naeng-bang-bi-reul bu-dam-ha-da", meaning: "承担制冷费用", grammar: "동사구", note: "能源贫困相关表达。" },
    { korean: "온열 질환", reading: "ol-lyeol jil-hwan", meaning: "热相关疾病", grammar: "명사구", note: "高温健康风险。" },
    { korean: "취약하다", reading: "chwi-yak-ha-da", meaning: "脆弱、易受影响", grammar: "형용사", note: "描述高风险群体。" },
    { korean: "재난 대응", reading: "jae-nan dae-eung", meaning: "灾害应对", grammar: "명사구", note: "公共政策领域词汇。" },
    { korean: "운영 중", reading: "un-yeong jung", meaning: "运营中", grammar: "명사구", note: "实时信息状态。" },
    { korean: "근무지를 벗어나다", reading: "geun-mu-ji-reul beo-seo-na-da", meaning: "离开工作地点", grammar: "동사구", note: "户外劳动者的使用障碍。" },
    { korean: "위험에 노출되다", reading: "wi-heo-me no-chul-doe-da", meaning: "暴露于危险", grammar: "피동", note: "政策风险表达。" },
    { korean: "접근성", reading: "jeop-geun-seong", meaning: "可达性、可及性", grammar: "명사", note: "评价避暑点成效的核心标准。" },
    { korean: "고위험 가구", reading: "go-wi-heom ga-gu", meaning: "高风险家庭", grammar: "명사구", note: "主动支援对象。" },
    { korean: "책임을 부과하다", reading: "chae-gi-meul bu-gwa-ha-da", meaning: "赋予、课以责任", grammar: "동사구", note: "说明雇主义务。" },
    { korean: "기후 안전망", reading: "gi-hu an-jeon-mang", meaning: "气候安全网", grammar: "명사구", note: "结论中的政策定位。" },
  ],
  grammarPoints: [
    { pattern: "V-(으)면서", meaning: "随着……", example: "폭염이 길어지면서 폭염 쉼터를 지정하고 있다.", note: "引出气候变化下的政策背景。" },
    { pattern: "N처럼", meaning: "像……一样", example: "혼자 사는 노인이나 야외 노동자처럼 취약한 사람에게 필요하다.", note: "列举具有共同特征的群体。" },
    { pattern: "V-다고 해서 ... 것은 아니다", meaning: "并非因为……就……", example: "쉼터의 수가 많다고 해서 시민이 실제로 보호받는 것은 아니다.", note: "否定以数量代替实际效果的判断。" },
    { pattern: "V-(으)ㄹ 때 비로소", meaning: "只有当……时才……", example: "필요한 지원과 연결할 때 비로소 안전망으로 기능할 수 있다.", note: "强调结论成立的必要条件。" },
  ],
  quiz: [
    { question: "文章认为 폭염 쉼터 可以发挥哪些作用？", answer: "它能为难以在家降温的人提供避暑空间，保护高风险群体，并把健康确认、饮水和急救信息等福利服务与灾害应对连接起来。" },
    { question: "为什么避暑点数量多不等于市民得到保护？", answer: "部分场所开放时间不实或无障碍条件不足，户外劳动者难以离岗，需要照护的人也可能无法独自抵达。" },
    { question: "作者主张如何把避暑点建设成气候安全网？", answer: "应提供实时运营信息，在交通站点和劳动现场附近设临时空间，主动联系高风险家庭并提供移动或上门支援，同时明确雇主的休息与供水责任。" },
  ],
  writingDrill: {
    type: "54 题观点写作",
    prompt:
      "폭염 쉼터가 도시의 기후 안전망으로 기능하기 위한 조건에 대해 쓰십시오. 취약 계층 보호와 복지 연결이라는 장점, 접근성과 이용 시간의 문제를 모두 언급하고, 효과적인 폭염 대응 방안을 두 가지 이상 제시하십시오.",
    checklist: ["폭염 쉼터", "취약 계층", "접근성", "고위험 가구", "기후 안전망"],
    sentenceBank: [
      "폭염 쉼터는 냉방 환경이 부족한 시민의 건강을 보호하는 중요한 시설이다.",
      "그러나 이용 시간과 이동 수단이 보장되지 않으면 가장 취약한 사람이 지원에서 제외될 수 있다.",
      "따라서 지방자치단체는 실시간 정보를 제공하고 고위험 가구를 먼저 찾아가는 지원 체계를 마련해야 한다.",
    ],
  },
};

const september20Reading: DailyReading = {
  id: "2026-09-20-local-bookstore-diversity",
  date: "2026-09-20",
  title: "지역 서점 지원은 문화 다양성을 지킬 수 있는가",
  level: "TOPIK II 5-6级",
  topic: "文化 / 经济",
  estimatedTime: "20 分钟",
  korean:
    "온라인 서점과 대형 유통망의 비중이 커지면서 동네에서 오랫동안 운영되던 지역 서점이 문을 닫는 경우가 늘고 있다. 소비자는 인터넷에서 책을 더 싸고 빠르게 살 수 있지만, 지역 서점이 사라지면 판매량이 적은 책이나 지역 작가의 작품을 우연히 만날 기회도 줄어든다. 지역 서점은 단순히 책을 파는 가게가 아니라 독서 모임, 작가 강연, 어린이 프로그램을 통해 주민이 문화 활동에 참여하는 작은 거점이기도 하다. 이런 이유로 일부 지방자치단체는 임대료를 지원하거나 공공도서관의 도서 구매 물량을 지역 서점에 배정하고 있다. 그러나 지원금만 제공한다고 해서 서점이 지속 가능한 공간이 되는 것은 아니다. 지원 대상이 매출이나 운영 기간만으로 정해지면 새로 문을 연 서점이나 규모가 작은 전문 서점은 제외될 수 있다. 공공기관의 구매 물량에 지나치게 의존할 경우 서점이 독자의 취향을 발견하고 독창적인 책을 소개하는 기능보다 행정 기준을 맞추는 데 집중할 가능성도 있다. 반대로 모든 지역 서점을 보호해야 한다는 이유로 서비스 개선과 경영 혁신을 요구하지 않는다면 한정된 예산의 효과를 설명하기 어렵다. 따라서 지역 서점 정책은 생존 자체보다 서점이 지역 문화에 어떤 가치를 만드는지를 평가해야 한다. 지방자치단체는 강연과 독서 모임의 참여도, 지역 출판물의 소개 실적, 학교와의 협력 등을 지원 기준에 포함할 수 있다. 서점끼리 공동 배송망과 온라인 주문 시스템을 구축하도록 도우면 가격과 편의성의 격차도 줄일 수 있다. 주민 역시 지역 서점을 단순한 보호 대상으로 보는 데서 벗어나 자신이 원하는 문화 프로그램을 함께 기획하는 이용자가 되어야 한다. 결국 지역 서점 지원의 목적은 특정 가게의 매출을 보전하는 데 있지 않고, 다양한 책과 생각이 지역 안에서 계속 유통될 수 있는 조건을 만드는 데 있다.",
  chinese:
    "随着网络书店和大型流通渠道所占比重增大，经营多年的社区独立书店不断关门。消费者可以在网上更便宜、更快捷地买书，但独立书店一旦消失，偶然遇见销量较少的书或本地作家作品的机会也会减少。独立书店不仅是卖书的商店，也会通过读书会、作家讲座和儿童项目，成为居民参与文化活动的小型据点。因此，一些地方政府会补贴租金，或把公共图书馆的部分购书额度分配给本地书店。然而，仅仅提供补贴并不能让书店成为可持续空间。如果援助对象只按销售额或经营年限确定，新开书店和规模较小的专业书店可能被排除。若过度依赖公共机构的采购量，书店也可能不再专注于发现读者兴趣、介绍有特色的书，而把重心放在满足行政标准上。相反，如果以保护所有本地书店为由，不要求改善服务和经营创新，就很难说明有限预算的成效。因此，独立书店政策不应只评价其是否存活，而应评价书店为本地文化创造了何种价值。地方政府可以把讲座和读书会参与度、本地出版物介绍成果、与学校合作等纳入援助标准。帮助书店共同建设配送网络和线上订购系统，也能缩小价格与便利性的差距。居民也应摆脱把独立书店仅仅视为保护对象的观念，成为共同策划所需文化活动的使用者。归根结底，扶持独立书店的目的并非补偿某家商店的营业额，而是创造条件，让多样的书籍和思想能持续在地区内流通。",
  tokens: [
    { korean: "대형 유통망", reading: "dae-hyeong yu-tong-mang", meaning: "大型流通网络", grammar: "명사구", note: "说明市场竞争结构。" },
    { korean: "문을 닫다", reading: "mu-neul dat-da", meaning: "关门、停业", grammar: "동사구", note: "描述书店退出市场。" },
    { korean: "우연히 만나다", reading: "u-yeon-hi man-na-da", meaning: "偶然遇见", grammar: "동사구", note: "强调实体书店的发现价值。" },
    { korean: "문화 거점", reading: "mun-hwa geo-jeom", meaning: "文化据点", grammar: "명사구", note: "界定地区书店的公共作用。" },
    { korean: "물량을 배정하다", reading: "mul-lyang-eul bae-jeong-ha-da", meaning: "分配数量、额度", grammar: "동사구", note: "公共采购政策表达。" },
    { korean: "지속 가능하다", reading: "ji-sok ga-neung-ha-da", meaning: "可持续", grammar: "형용사", note: "评价政策长期效果。" },
    { korean: "지원 대상", reading: "ji-won dae-sang", meaning: "援助对象", grammar: "명사구", note: "讨论政策覆盖范围。" },
    { korean: "지나치게 의존하다", reading: "ji-na-chi-ge ui-jon-ha-da", meaning: "过度依赖", grammar: "동사구", note: "指出公共采购依赖风险。" },
    { korean: "독창적인", reading: "dok-chang-jeo-gin", meaning: "独创的、有特色的", grammar: "관형사형", note: "修饰书店选书功能。" },
    { korean: "한정된 예산", reading: "han-jeong-doen ye-san", meaning: "有限预算", grammar: "명사구", note: "政策资源约束。" },
    { korean: "소개 실적", reading: "so-gae sil-jeok", meaning: "介绍成果、业绩", grammar: "명사구", note: "可用于支持评估。" },
    { korean: "공동 배송망", reading: "gong-dong bae-song-mang", meaning: "共同配送网络", grammar: "명사구", note: "降低经营成本的合作方式。" },
    { korean: "매출을 보전하다", reading: "mae-chu-reul bo-jeon-ha-da", meaning: "补偿营业额", grammar: "동사구", note: "与文化政策目标形成对比。" },
  ],
  grammarPoints: [
    { pattern: "V-(으)면서", meaning: "随着……", example: "온라인 서점의 비중이 커지면서 지역 서점이 문을 닫는 경우가 늘고 있다.", note: "引出市场环境变化。" },
    { pattern: "V-다고 해서 ... 것은 아니다", meaning: "并非因为……就……", example: "지원금만 제공한다고 해서 서점이 지속 가능한 공간이 되는 것은 아니다.", note: "反驳补贴万能论。" },
    { pattern: "V-(으)ㄹ 경우", meaning: "在……情况下", example: "공공기관의 구매 물량에 지나치게 의존할 경우 행정 기준에 집중할 수 있다.", note: "正式文章中说明条件和后果。" },
    { pattern: "N에 있는 것이 아니라 ... 데 있다", meaning: "不在于……而在于……", example: "목적은 매출을 보전하는 데 있는 것이 아니라 다양한 생각이 유통될 조건을 만드는 데 있다.", note: "适合 TOPIK 高级结论段。" },
  ],
  quiz: [
    { question: "文章认为地区书店除了售书之外还有什么价值？", answer: "它能让读者发现小众书和本地作品，并通过读书会、讲座和儿童活动成为居民参与文化生活的地区据点。" },
    { question: "现有扶持方式可能产生哪些问题？", answer: "单一的销售额或经营年限标准可能排除新书店和小型专业书店；过度依赖公共采购也可能使书店偏离发现读者需求和独立选书的功能。" },
    { question: "作者建议如何提高地区书店政策的效果？", answer: "按文化活动参与度、本地出版物介绍和学校合作等价值评估支持，并帮助书店建设共同配送与线上订购系统，同时让居民参与文化项目策划。" },
  ],
  writingDrill: {
    type: "54 题观点写作",
    prompt:
      "지역 서점 지원 정책이 문화 다양성과 지역 경제에 미치는 영향에 대해 쓰십시오. 문화 거점과 다양한 책의 유통이라는 장점, 지원 기준과 공공 구매 의존 문제를 모두 언급하고, 지속 가능한 운영 방안을 두 가지 이상 제시하십시오.",
    checklist: ["지역 서점", "문화 다양성", "지원 기준", "공공 구매", "공동 배송망"],
    sentenceBank: [
      "지역 서점은 주민이 다양한 책과 문화 활동을 만나는 생활권 안의 문화 거점이다.",
      "그러나 단순한 보조금이나 공공 구매에 의존하면 서점의 독창성이 약해질 수 있다.",
      "따라서 문화적 기여를 평가하고 공동 유통 기반을 지원하는 장기적인 정책이 필요하다.",
    ],
  },
};

const september21Reading: DailyReading = {
  id: "2026-09-21-right-to-disconnect",
  date: "2026-09-21",
  title: "업무 연결 차단권은 일과 휴식의 경계를 지킬 수 있는가",
  level: "TOPIK II 5-6级",
  topic: "职场 / 公共政策",
  estimatedTime: "20 分钟",
  korean:
    "스마트폰과 협업 도구가 널리 사용되면서 직장인은 사무실을 벗어난 뒤에도 업무 메시지를 쉽게 확인할 수 있게 되었다. 긴급한 문제를 빠르게 해결하고 근무 장소가 다른 동료와 협력하기에는 편리하지만, 퇴근 후 연락이 일상화되면 노동자는 실제로 쉬는 시간에도 업무에서 벗어나기 어렵다. 알림을 확인하지 않으면 책임감이 부족한 사람으로 보일까 걱정해 즉시 답하는 문화가 형성되면, 공식 근무 시간과 실제 노동 시간의 차이는 점점 커진다. 이에 따라 일부 국가와 기업은 근무 시간 밖의 연락에 응답하지 않아도 불이익을 받지 않는 업무 연결 차단권을 도입하고 있다. 그러나 연락을 금지하는 규칙만 만든다고 해서 휴식권이 저절로 보장되는 것은 아니다. 해외 고객을 상대하거나 교대 근무를 하는 조직에서는 모든 구성원에게 같은 시간을 적용하기 어렵고, 안전사고나 서비스 장애처럼 즉각적인 대응이 필요한 상황도 존재한다. 관리자가 직접 메시지를 보내지 않더라도 다음 날 아침까지 끝내야 할 과제를 늦은 시간에 배정한다면 노동자는 사실상 야간 업무를 계속하게 된다. 반대로 노동자가 언제나 연락을 거부할 수 있다는 원칙만 강조하면 동료에게 예상하지 못한 부담이 집중될 수도 있다. 따라서 연결 차단권은 연락 여부보다 업무량과 책임 배분을 함께 조정하는 제도로 설계되어야 한다. 조직은 긴급 연락이 허용되는 상황과 담당자를 미리 정하고, 일반 메시지는 예약 전송 기능을 사용하도록 할 수 있다. 근무 시간 밖에 처리한 업무는 기록해 보상 휴가나 수당으로 돌려주어야 하며, 응답 속도를 인사 평가에 반영하지 않는다는 기준도 명확히 밝혀야 한다. 구성원은 자신의 근무 가능 시간을 공유하고 업무 인수인계 절차를 지켜 동료의 휴식을 함께 보호할 필요가 있다. 결국 연결 차단권의 목적은 소통을 막는 데 있지 않고, 필요한 소통이 개인의 희생에 기대지 않도록 조직의 운영 방식을 바꾸는 데 있다.",
  chinese:
    "随着智能手机和协作工具普及，上班族即使离开办公室，也能轻易查看工作消息。这有助于快速解决紧急问题，也方便与不同地点的同事协作；但如果下班后联系成为常态，劳动者即使在休息时间也难以真正脱离工作。一旦形成这样的文化：担心不看通知会被认为缺乏责任感，所以必须立即回复，那么正式工时与实际劳动时间之间的差距就会不断扩大。因此，一些国家和企业开始引入“工作断联权”，规定员工在非工作时间不回复联系也不会受到不利待遇。然而，仅制定禁止联系的规则并不会自动保障休息权。面对海外客户或实行轮班的组织，很难对所有成员采用相同时间；安全事故、服务故障等情况也确实需要立即应对。即使管理者不直接发消息，如果深夜才布置第二天早晨前必须完成的任务，劳动者实际上仍在继续夜间工作。反过来，如果只强调劳动者随时可以拒绝联系，意外负担也可能集中到同事身上。因此，断联权应被设计成同时调整工作量与责任分配的制度，而不只是规定是否可以联系。组织应预先确定允许紧急联系的情形与负责人，并让普通消息使用定时发送功能。非工作时间完成的工作应被记录，并以补休或加班费补偿；也应明确回复速度不纳入人事评价。成员则需要共享自己的可工作时间，遵守工作交接流程，共同保护同事休息。归根结底，断联权的目的不是阻断沟通，而是改变组织运行方式，使必要沟通不再依赖个人牺牲。",
  tokens: [
    { korean: "협업 도구", reading: "hyeop-eop do-gu", meaning: "协作工具", grammar: "명사구", note: "远程和混合办公语境中的核心工具。" },
    { korean: "일상화되다", reading: "il-sang-hwa-doe-da", meaning: "成为常态", grammar: "피동", note: "描述下班联系逐渐固定化。" },
    { korean: "업무에서 벗어나다", reading: "eom-mu-e-seo beo-seo-na-da", meaning: "脱离工作", grammar: "동사구", note: "界定真正休息的状态。" },
    { korean: "책임감이 부족하다", reading: "chae-gim-gam-i bu-jok-ha-da", meaning: "责任感不足", grammar: "형용사구", note: "说明即时回复压力的来源。" },
    { korean: "불이익을 받다", reading: "bul-i-i-geul bat-da", meaning: "受到不利待遇", grammar: "동사구", note: "断联权保护的具体内容。" },
    { korean: "업무 연결 차단권", reading: "eom-mu yeon-gyeol cha-dan-gwon", meaning: "工作断联权", grammar: "명사구", note: "文章核心制度概念。" },
    { korean: "교대 근무", reading: "gyo-dae geun-mu", meaning: "轮班工作", grammar: "명사구", note: "统一断联时段的现实困难。" },
    { korean: "즉각적인 대응", reading: "jeuk-gak-jeo-gin dae-eung", meaning: "即时应对", grammar: "명사구", note: "紧急联络的正当理由。" },
    { korean: "사실상", reading: "sa-sil-ssang", meaning: "事实上、实际上", grammar: "부사", note: "揭示形式规则与实际劳动的差异。" },
    { korean: "책임 배분", reading: "chae-gim bae-bun", meaning: "责任分配", grammar: "명사구", note: "制度设计的重点之一。" },
    { korean: "예약 전송", reading: "ye-yak jeon-song", meaning: "定时发送", grammar: "명사구", note: "减少非工作时间打扰的具体措施。" },
    { korean: "보상 휴가", reading: "bo-sang hyu-ga", meaning: "补偿性休假、补休", grammar: "명사구", note: "非工作时间劳动的补偿方式。" },
    { korean: "인수인계", reading: "in-su-in-gye", meaning: "工作交接", grammar: "명사", note: "保护团队成员休息的协作条件。" },
  ],
  grammarPoints: [
    { pattern: "V-(으)면서", meaning: "随着……", example: "협업 도구가 널리 사용되면서 업무 메시지를 쉽게 확인할 수 있게 되었다.", note: "引出技术变化及其影响。" },
    { pattern: "V-다고 해서 ... 것은 아니다", meaning: "并非因为……就……", example: "연락을 금지하는 규칙만 만든다고 해서 휴식권이 저절로 보장되는 것은 아니다.", note: "反驳单一制度即可解决问题的观点。" },
    { pattern: "V-더라도", meaning: "即使……也……", example: "관리자가 직접 메시지를 보내지 않더라도 야간 업무가 계속될 수 있다.", note: "说明形式上不联系仍可能产生实质劳动。" },
    { pattern: "N에 있는 것이 아니라 ... 데 있다", meaning: "不在于……而在于……", example: "목적은 소통을 막는 데 있는 것이 아니라 운영 방식을 바꾸는 데 있다.", note: "用于高级议论文的价值重申。" },
  ],
  quiz: [
    { question: "文章为什么认为下班后的即时回复文化存在问题？", answer: "劳动者会因担心被认为缺乏责任感而继续处理消息，导致休息时间无法脱离工作，正式工时与实际劳动时间的差距扩大。" },
    { question: "为什么单纯禁止非工作时间联系并不足够？", answer: "轮班、海外业务和紧急事故确实需要例外；管理者还可能通过深夜布置限时任务变相延长劳动，或把负担转移给其他同事。" },
    { question: "作者提出了哪些落实断联权的措施？", answer: "预先规定紧急联络情形与负责人，普通消息定时发送，记录并补偿非工作时间劳动，禁止把回复速度用于考核，同时完善工作时间共享和交接流程。" },
  ],
  writingDrill: {
    type: "54 题观点写作",
    prompt:
      "업무 연결 차단권이 직장 문화와 노동자의 삶에 미치는 영향에 대해 쓰십시오. 휴식권 보장과 업무 집중도 향상이라는 장점, 긴급 대응과 동료 간 부담 배분 문제를 모두 언급하고, 효과적인 운영 방안을 두 가지 이상 제시하십시오.",
    checklist: ["업무 연결 차단권", "휴식권", "긴급 연락", "책임 배분", "보상 휴가"],
    sentenceBank: [
      "업무 연결 차단권은 노동자가 근무 시간 밖에 충분히 회복하도록 보장하는 제도이다.",
      "그러나 긴급 상황의 기준과 담당자가 불분명하면 업무 공백이나 동료 간 갈등이 생길 수 있다.",
      "따라서 조직은 예외 상황을 미리 정하고 시간 외 노동을 기록하여 정당하게 보상해야 한다.",
    ],
  },
};

const september22Reading: DailyReading = {
  id: "2026-09-22-digital-badge-credentials",
  date: "2026-09-22",
  title: "디지털 배지는 학력 중심의 평가를 바꿀 수 있는가",
  level: "TOPIK II 5-6级",
  topic: "教育 / 科技",
  estimatedTime: "20 分钟",
  korean:
    "산업 구조가 빠르게 변하면서 한 번 취득한 학위만으로 개인의 능력을 오랫동안 설명하기 어려워지고 있다. 이에 대학과 직업 교육 기관은 짧은 과정을 이수하거나 특정 프로젝트를 완성한 사람에게 디지털 배지를 발급하고 있다. 디지털 배지에는 학습 내용, 평가 방법, 발급 기관 등의 정보가 담겨 있어 지원자가 어떤 기술을 실제로 익혔는지 구체적으로 보여 줄 수 있다. 경력이 단절되었거나 정규 대학에 다니기 어려운 사람도 필요한 역량을 단계적으로 증명할 수 있다는 점에서 디지털 배지는 평생 학습의 문턱을 낮출 가능성이 있다. 그러나 배지의 수가 많아진다고 해서 학력 중심의 평가가 자동으로 사라지는 것은 아니다. 기관마다 교육 시간과 평가 기준이 다르면 같은 이름의 배지라도 능력 수준을 비교하기 어렵다. 기업이 익숙한 대학 이름 대신 수십 개의 배지를 하나씩 검토해야 한다면 채용 과정의 부담이 오히려 커질 수 있다. 비용을 낼 수 있는 사람이 여러 과정을 빠르게 수강해 배지를 모으는 반면, 노동과 돌봄 때문에 학습 시간이 부족한 사람은 새로운 경쟁에서도 불리해질 수 있다. 또한 실제 과제를 수행하는 능력보다 배지의 개수만 강조되면 학습이 짧은 인증서를 수집하는 활동으로 변질될 위험도 있다. 따라서 디지털 배지가 신뢰를 얻으려면 발급보다 검증 체계를 먼저 갖추어야 한다. 교육 기관은 배지가 어떤 수준의 지식과 수행 능력을 의미하는지 공개하고, 독립된 기관은 평가 절차와 학습 성과를 정기적으로 점검해야 한다. 기업은 배지를 서류 심사의 추가 기준으로만 활용하지 말고 실제 과제, 경력, 학습 과정을 함께 평가할 필요가 있다. 정부도 취약 계층에게 교육비와 학습 시간을 지원해 새로운 자격 체계가 또 다른 격차를 만들지 않도록 해야 한다. 결국 디지털 배지의 가치는 학위를 완전히 대신하는 데 있지 않고, 한 사람의 다양한 학습 경험을 더 세밀하고 공정하게 인정하는 데 있다.",
  chinese:
    "随着产业结构快速变化，仅靠一次取得的学位，越来越难以长期说明个人能力。因此，大学和职业教育机构开始向完成短期课程或特定项目的人发放数字徽章。数字徽章包含学习内容、评价方式和发放机构等信息，可以具体展示申请者实际掌握了哪些技能。对于职业中断或难以进入正规大学的人来说，也能分阶段证明所需能力，因此数字徽章有望降低终身学习的门槛。然而，徽章数量增加，并不意味着学历中心的评价会自动消失。各机构的教学时长和评价标准若不同，即使徽章名称相同，也很难比较能力水平。如果企业必须逐一审核数十个徽章，而不是熟悉的大学名称，招聘负担反而可能增加。有能力支付费用的人可以快速修读多门课程、收集徽章，而因劳动和照护缺少学习时间的人，在新的竞争中仍可能处于不利地位。此外，如果只强调徽章数量而非完成实际任务的能力，学习也可能异化为收集短期证书的活动。因此，数字徽章要获得信任，必须先建立验证体系，而不是只扩大颁发。教育机构应公开徽章代表的知识和实践能力水平，独立机构则应定期检查评价程序与学习成果。企业不应只把徽章当作书面筛选的附加条件，而应同时评价实际任务、工作经历和学习过程。政府也应为弱势群体提供教育费用和学习时间支持，避免新的资格体系制造另一种差距。归根结底，数字徽章的价值不在于完全取代学位，而在于更细致、公平地承认一个人的多样学习经历。",
  tokens: [
    { korean: "산업 구조", reading: "san-eop gu-jo", meaning: "产业结构", grammar: "명사구", note: "引出能力需求变化的背景。" },
    { korean: "학위를 취득하다", reading: "ha-gwi-reul chwi-deuk-ha-da", meaning: "取得学位", grammar: "동사구", note: "传统学历认证表达。" },
    { korean: "과정을 이수하다", reading: "gwa-jeong-eul i-su-ha-da", meaning: "修完课程", grammar: "동사구", note: "教育制度中的常用搭配。" },
    { korean: "디지털 배지", reading: "di-ji-teol bae-ji", meaning: "数字徽章", grammar: "명사구", note: "文章核心概念。" },
    { korean: "발급 기관", reading: "bal-geup gi-gwan", meaning: "颁发机构", grammar: "명사구", note: "徽章可信度的信息来源。" },
    { korean: "역량을 증명하다", reading: "yeok-nyang-eul jeung-myeong-ha-da", meaning: "证明能力", grammar: "동사구", note: "说明徽章的主要用途。" },
    { korean: "문턱을 낮추다", reading: "mun-teo-geul nat-chu-da", meaning: "降低门槛", grammar: "동사구", note: "描述扩大教育机会。" },
    { korean: "평가 기준", reading: "pyeong-ga gi-jun", meaning: "评价标准", grammar: "명사구", note: "不同机构之间可比性的关键。" },
    { korean: "채용 과정의 부담", reading: "chae-yong gwa-jeong-ui bu-dam", meaning: "招聘流程负担", grammar: "명사구", note: "企业采用新认证的成本。" },
    { korean: "불리해지다", reading: "bul-li-hae-ji-da", meaning: "变得不利", grammar: "형용사", note: "说明新的教育差距。" },
    { korean: "변질되다", reading: "byeon-jil-doe-da", meaning: "变质、异化", grammar: "피동", note: "批评只追求证书数量。" },
    { korean: "검증 체계", reading: "geom-jeung che-gye", meaning: "验证体系", grammar: "명사구", note: "政策建议的核心。" },
    { korean: "학습 성과", reading: "hak-seup seong-gwa", meaning: "学习成果", grammar: "명사구", note: "认证质量评价对象。" },
  ],
  grammarPoints: [
    { pattern: "V-(으)면서", meaning: "随着……", example: "산업 구조가 빠르게 변하면서 학위만으로 능력을 설명하기 어려워지고 있다.", note: "引出社会变化和制度需求。" },
    { pattern: "V-다는 점에서", meaning: "从……这一点来看", example: "역량을 단계적으로 증명할 수 있다는 점에서 평생 학습의 문턱을 낮출 수 있다.", note: "用于评价某项制度的意义。" },
    { pattern: "V-다고 해서 ... 것은 아니다", meaning: "并非因为……就……", example: "배지의 수가 많아진다고 해서 학력 중심의 평가가 사라지는 것은 아니다.", note: "反驳数量增长等同于制度改变的看法。" },
    { pattern: "N에 있지 않고 ... 데 있다", meaning: "不在于……而在于……", example: "가치는 학위를 대신하는 데 있지 않고 다양한 학습을 인정하는 데 있다.", note: "适合高级写作结论。" },
  ],
  quiz: [
    { question: "文章认为数字徽章可以给学习者带来什么好处？", answer: "它能具体展示学习内容和实际技能，使职业中断或难以接受正规大学教育的人分阶段证明能力，从而降低终身学习门槛。" },
    { question: "数字徽章为什么可能制造新的不公平？", answer: "机构标准不统一会降低可比性；有金钱和时间的人更容易收集徽章，而承担劳动与照护的人可能再次处于不利地位。" },
    { question: "作者认为应如何建立可信的数字徽章制度？", answer: "教育机构公开能力标准，独立机构定期验证评价和成果，企业结合实际任务、经历与学习过程进行评价，政府为弱势群体提供费用和时间支持。" },
  ],
  writingDrill: {
    type: "54 题观点写作",
    prompt:
      "디지털 배지가 교육과 채용 평가에 미치는 영향에 대해 쓰십시오. 평생 학습 기회와 구체적인 역량 증명이라는 장점, 평가 기준의 차이와 새로운 교육 격차 문제를 모두 언급하고, 신뢰할 수 있는 운영 방안을 두 가지 이상 제시하십시오.",
    checklist: ["디지털 배지", "평생 학습", "평가 기준", "교육 격차", "검증 체계"],
    sentenceBank: [
      "디지털 배지는 학위만으로 드러나지 않는 구체적인 기술과 학습 경험을 보여 줄 수 있다.",
      "그러나 발급 기준이 서로 다르면 배지의 수가 늘어도 채용 현장에서 신뢰를 얻기 어렵다.",
      "따라서 교육 기관은 평가 기준을 공개하고 독립 기관은 학습 성과를 정기적으로 검증해야 한다.",
    ],
  },
};

const september23Reading: DailyReading = {
  id: "2026-09-23-reusable-packaging-deposit",
  date: "2026-09-23",
  title: "다회용 포장 보증금제는 일회용품을 줄일 수 있는가",
  level: "TOPIK II 5-6级",
  topic: "环境 / 经济",
  estimatedTime: "20 分钟",
  korean:
    "배달 음식과 온라인 주문이 늘면서 한 번 사용한 뒤 버려지는 포장 용기의 양도 빠르게 증가하고 있다. 이를 줄이기 위해 일부 지역에서는 소비자가 다회용 용기를 받을 때 보증금을 내고, 사용한 용기를 반납하면 돈을 돌려받는 제도를 운영하고 있다. 용기가 여러 차례 순환하면 일회용품 생산과 폐기 과정에서 발생하는 자원 소비와 탄소 배출을 줄일 수 있다. 소비자에게 반납에 대한 경제적 동기를 제공하고, 기업에도 포장 폐기물의 책임을 나누게 한다는 점에서 보증금제는 생산과 소비의 방식을 바꿀 가능성이 있다. 그러나 다회용이라는 이름만으로 환경 효과가 보장되는 것은 아니다. 용기를 회수하는 차량이 먼 거리를 이동하거나 세척 과정에서 많은 물과 에너지를 사용하면 일회용 용기보다 환경 부담이 더 커질 수도 있다. 반납 장소가 적고 운영 업체마다 용기의 규격이 다르면 소비자는 여러 종류의 용기를 따로 보관해야 하므로 참여를 포기하기 쉽다. 보증금이 지나치게 높으면 초기 비용이 부담되고, 너무 낮으면 반납을 유도하기 어렵다. 또한 회수되지 않은 용기의 비용을 소비자에게만 맡길 경우 기업은 편리한 회수망을 만들 책임을 피할 수 있다. 따라서 제도의 성과는 사용된 다회용 용기의 수가 아니라 실제 반납률과 반복 사용 횟수로 평가해야 한다. 지방자치단체는 여러 음식점과 배달 업체가 함께 쓸 수 있는 표준 용기를 마련하고, 지하철역이나 공동 주택처럼 접근하기 쉬운 곳에 반납함을 설치할 필요가 있다. 세척 시설은 물과 에너지 사용량을 공개하고 위생 기준에 대한 정기 검사를 받아야 한다. 기업에는 회수와 세척 비용의 일부를 부담하게 하되, 소규모 상점에는 공동 물류와 초기 설비를 지원할 수 있다. 결국 다회용 포장 보증금제의 목적은 소비자에게 용기 하나를 더 관리하게 하는 데 있지 않고, 포장이 버려지지 않고 순환하는 기반을 사회 전체가 함께 만드는 데 있다.",
  chinese:
    "随着外卖和线上订购增加，一次使用后被丢弃的包装容器也在快速增多。为减少这种浪费，一些地区实行押金制度：消费者领取可重复使用的容器时支付押金，归还用过的容器后再取回押金。容器若能多次循环，就可以减少生产和废弃一次性用品时产生的资源消耗与碳排放。押金既给消费者提供归还的经济动机，也让企业分担包装废弃物责任，因此可能改变生产与消费方式。然而，仅仅冠以“可重复使用”之名，并不能保证环境效果。如果回收车辆长距离行驶，或清洗过程耗费大量水和能源，其环境负担甚至可能高于一次性容器。如果归还点太少、不同运营商的容器规格又不统一，消费者就必须分别保管多种容器，很容易放弃参与。押金过高会造成初始费用负担，过低又难以推动归还。此外，如果把未回收容器的成本只交给消费者，企业就可能逃避建设便利回收网络的责任。因此，制度成效不应按使用了多少可循环容器来评价，而应看实际归还率和重复使用次数。地方政府应制定供多家餐厅和配送企业共同使用的标准容器，并在地铁站、小区等易到达之处设置归还箱。清洗设施应公开水和能源使用量，定期接受卫生标准检查。企业应承担部分回收和清洗费用，同时可为小商户提供共同物流和初始设备支持。归根结底，押金制的目的不是让消费者多管理一个容器，而是由整个社会共同建立包装不被丢弃、持续循环的基础。",
  tokens: [
    { korean: "포장 용기", reading: "po-jang yong-gi", meaning: "包装容器", grammar: "명사구", note: "文章讨论的主要物品。" },
    { korean: "보증금을 내다", reading: "bo-jeung-geu-meul nae-da", meaning: "支付押金", grammar: "동사구", note: "押金制度的起始行为。" },
    { korean: "반납하다", reading: "ban-nap-ha-da", meaning: "归还", grammar: "동사", note: "实现容器循环的关键动作。" },
    { korean: "여러 차례 순환하다", reading: "yeo-reo cha-rye sun-hwan-ha-da", meaning: "多次循环使用", grammar: "동사구", note: "衡量环保效果的条件。" },
    { korean: "탄소 배출", reading: "tan-so bae-chul", meaning: "碳排放", grammar: "명사구", note: "环境影响指标。" },
    { korean: "경제적 동기", reading: "gyeong-je-jeok dong-gi", meaning: "经济动机", grammar: "명사구", note: "推动消费者归还的机制。" },
    { korean: "환경 부담", reading: "hwan-gyeong bu-dam", meaning: "环境负担", grammar: "명사구", note: "比较包装方案的概念。" },
    { korean: "용기의 규격", reading: "yong-gi-ui gyu-gyeok", meaning: "容器规格", grammar: "명사구", note: "影响系统兼容性。" },
    { korean: "참여를 포기하다", reading: "cham-yeo-reul po-gi-ha-da", meaning: "放弃参与", grammar: "동사구", note: "制度不便带来的结果。" },
    { korean: "초기 비용", reading: "cho-gi bi-yong", meaning: "初始费用", grammar: "명사구", note: "消费者和小商户的进入成本。" },
    { korean: "반납률", reading: "ban-nap-nyul", meaning: "归还率", grammar: "명사", note: "评价制度实效的核心指标。" },
    { korean: "표준 용기", reading: "pyo-jun yong-gi", meaning: "标准容器", grammar: "명사구", note: "跨企业共同使用的基础。" },
    { korean: "공동 물류", reading: "gong-dong mul-lyu", meaning: "共同物流", grammar: "명사구", note: "降低小商户运营成本的方案。" },
  ],
  grammarPoints: [
    { pattern: "V-(으)면서", meaning: "随着……", example: "배달 음식이 늘면서 포장 용기의 양도 증가하고 있다.", note: "引出消费方式变化及其后果。" },
    { pattern: "V-다는 점에서", meaning: "从……这一点来看", example: "기업에도 책임을 나누게 한다는 점에서 소비 방식을 바꿀 가능성이 있다.", note: "用于评价制度意义。" },
    { pattern: "N만으로 ... V-는 것은 아니다", meaning: "仅凭……并不能……", example: "다회용이라는 이름만으로 환경 효과가 보장되는 것은 아니다.", note: "提醒区分名义和实际效果。" },
    { pattern: "N이 아니라 ... (으)로", meaning: "不是……而是以……", example: "용기의 수가 아니라 실제 반납률과 반복 사용 횟수로 평가해야 한다.", note: "提出更合理的评价标准。" },
  ],
  quiz: [
    { question: "文章认为可重复使用包装押金制有哪些积极作用？", answer: "它能通过押金鼓励消费者归还容器，减少一次性用品生产和废弃造成的资源消耗与碳排放，并让企业分担包装责任。" },
    { question: "为什么可重复使用容器不一定更环保？", answer: "长距离回收运输和高耗水、高耗能清洗可能增加环境负担；归还点少、规格不统一也会降低参与和重复使用次数。" },
    { question: "作者建议如何提高制度的实际效果？", answer: "采用跨企业标准容器，在交通站点和小区设置归还箱，公开并检查清洗资源与卫生情况，让企业分担成本并支持小商户的共同物流和设备。" },
  ],
  writingDrill: {
    type: "54 题观点写作",
    prompt:
      "다회용 포장 보증금제가 환경과 소비 생활에 미치는 영향에 대해 쓰십시오. 자원 절약과 기업 책임이라는 장점, 회수·세척 과정의 환경 부담과 소비자 불편 문제를 모두 언급하고, 효과적인 운영 방안을 두 가지 이상 제시하십시오.",
    checklist: ["다회용 포장", "보증금", "반납률", "표준 용기", "공동 물류"],
    sentenceBank: [
      "다회용 포장 보증금제는 소비자가 용기를 반납하도록 유도해 일회용품을 줄일 수 있다.",
      "그러나 회수 거리와 세척 자원까지 고려하지 않으면 환경 효과가 예상보다 작을 수 있다.",
      "따라서 표준 용기와 편리한 반납망을 구축하고 실제 반복 사용 횟수를 공개해야 한다.",
    ],
  },
};

const september24Reading: DailyReading = {
  id: "2026-09-24-senior-license-return",
  date: "2026-09-24",
  title: "고령 운전자의 면허 반납은 교통 안전을 높일 수 있는가",
  level: "TOPIK II 5-6级",
  topic: "社会 / 公共政策",
  estimatedTime: "20 分钟",
  korean:
    "고령 인구가 늘면서 고령 운전자의 교통사고를 줄이기 위한 정책이 중요한 과제로 떠오르고 있다. 일부 지방자치단체는 일정 연령 이상의 운전자가 면허를 자진 반납하면 교통카드나 지역 상품권을 제공한다. 시력과 반응 속도가 떨어진 운전자가 운전을 중단하도록 유도하면 사고 위험을 낮출 수 있고, 본인과 보행자의 안전도 함께 보호할 수 있다는 취지이다. 특히 대중교통이 잘 갖추어진 도시에서는 면허 반납이 생활의 큰 불편 없이 안전한 이동 방식으로 전환하는 계기가 될 수 있다. 그러나 나이만을 기준으로 운전 능력을 판단한다고 해서 교통 안전이 충분히 확보되는 것은 아니다. 같은 연령이라도 건강 상태와 운전 습관은 크게 다르며, 젊은 운전자에게도 과속이나 부주의로 인한 위험이 존재한다. 농촌이나 외곽 지역에서는 병원과 시장까지 가는 버스가 자주 오지 않기 때문에 운전을 그만두면 일상생활 자체가 어려워질 수 있다. 한 번 지급되는 상품권은 장기간 필요한 이동 비용을 보장하지 못하며, 가족에게 이동을 의존하게 되면 고령자의 자율성이 약해질 가능성도 있다. 반납 실적만 강조할 경우 행정 기관이 대체 교통을 마련하지 않은 채 개인에게 안전 책임을 넘기는 결과가 될 수 있다. 따라서 정책의 목표는 면허증을 회수하는 데 머물지 않고 운전 능력을 정확히 평가하고 안전한 이동권을 보장하는 데 두어야 한다. 정부는 연령과 관계없이 시력, 인지 능력, 실제 주행 능력을 정기적으로 점검하는 제도를 강화할 필요가 있다. 운전이 가능한 사람에게는 야간 운전이나 고속도로 이용을 제한하는 조건부 면허를 적용할 수 있다. 운전을 중단한 사람에게는 수요에 따라 운행하는 마을버스, 택시 요금 지원, 병원 동행 서비스 등을 지속적으로 제공해야 한다. 결국 고령 운전자 정책은 운전대를 놓게 하는 정책이 아니라, 누구나 위험을 줄이면서도 필요한 곳에 이동할 수 있게 하는 정책이어야 한다.",
  chinese:
    "随着老龄人口增加，减少老年驾驶者交通事故已成为重要政策课题。一些地方政府规定，达到一定年龄的驾驶者自愿交还驾照后，可获得交通卡或地方商品券。其目的在于引导视力和反应速度下降的人停止驾驶，从而降低事故风险，同时保护本人和行人安全。尤其在公共交通完善的城市，交还驾照可以成为在不造成严重生活不便的情况下转向安全出行方式的契机。然而，仅凭年龄判断驾驶能力，并不能充分保障交通安全。即使年龄相同，健康状况和驾驶习惯也有很大差异；年轻驾驶者同样存在超速、疏忽造成的风险。在农村或郊区，前往医院和市场的公交班次不多，一旦停止驾驶，日常生活本身就可能变得困难。一次性商品券无法保障长期所需的出行费用；若必须依赖家人接送，老年人的自主性也可能减弱。如果只强调交还数量，行政机关可能在没有提供替代交通的情况下，把安全责任转嫁给个人。因此，政策目标不应停留在收回驾照，而应准确评价驾驶能力并保障安全移动权。政府应加强不分年龄、定期检查视力、认知能力和实际驾驶能力的制度。对于仍可驾驶的人，可以适用限制夜间驾驶或高速公路使用的条件式驾照。对于停止驾驶的人，则应持续提供按需运行的社区公交、出租车费用补助和就医陪同服务。归根结底，老年驾驶政策不应只是让人放下方向盘，而应让任何人都能在降低风险的同时前往必要地点。",
  tokens: [
    { korean: "고령 인구", reading: "go-ryeong in-gu", meaning: "老龄人口", grammar: "명사구", note: "政策出现的人口背景。" },
    { korean: "면허를 자진 반납하다", reading: "myeon-heo-reul ja-jin ban-nap-ha-da", meaning: "自愿交还驾照", grammar: "동사구", note: "文章核心政策行为。" },
    { korean: "반응 속도", reading: "ban-eung sok-do", meaning: "反应速度", grammar: "명사구", note: "驾驶能力评价因素。" },
    { korean: "운전을 중단하다", reading: "un-jeo-neul jung-dan-ha-da", meaning: "停止驾驶", grammar: "동사구", note: "政策期待的行为变化。" },
    { korean: "취지", reading: "chwi-ji", meaning: "宗旨、意图", grammar: "명사", note: "正式政策文章常用词。" },
    { korean: "이동 방식으로 전환하다", reading: "i-dong bang-si-geu-ro jeon-hwan-ha-da", meaning: "转向另一种出行方式", grammar: "동사구", note: "说明交通方式转换。" },
    { korean: "운전 습관", reading: "un-jeon seup-gwan", meaning: "驾驶习惯", grammar: "명사구", note: "年龄以外的风险因素。" },
    { korean: "일상생활 자체", reading: "il-sang-saeng-hwal ja-che", meaning: "日常生活本身", grammar: "명사구", note: "强调无车生活的严重影响。" },
    { korean: "자율성이 약해지다", reading: "ja-yul-seong-i yak-hae-ji-da", meaning: "自主性减弱", grammar: "동사구", note: "依赖家人出行的副作用。" },
    { korean: "책임을 넘기다", reading: "chae-gi-meul neom-gi-da", meaning: "转嫁责任", grammar: "동사구", note: "批评只追求反还数量。" },
    { korean: "조건부 면허", reading: "jo-geon-bu myeon-heo", meaning: "条件式驾照", grammar: "명사구", note: "介于完全驾驶和完全停止之间的方案。" },
    { korean: "수요에 따라 운행하다", reading: "su-yo-e tta-ra un-haeng-ha-da", meaning: "按需求运行", grammar: "동사구", note: "偏远地区交通方案。" },
    { korean: "이동권", reading: "i-dong-gwon", meaning: "移动权、出行权", grammar: "명사", note: "文章最终要保障的权利。" },
  ],
  grammarPoints: [
    { pattern: "V-(으)면서", meaning: "随着……", example: "고령 인구가 늘면서 교통사고를 줄이기 위한 정책이 중요해지고 있다.", note: "引出人口变化与政策需求。" },
    { pattern: "V-도록 유도하다", meaning: "引导……", example: "운전자가 운전을 중단하도록 유도하면 사고 위험을 낮출 수 있다.", note: "说明政策诱导目标。" },
    { pattern: "V-다고 해서 ... 것은 아니다", meaning: "并非因为……就……", example: "나이만으로 판단한다고 해서 교통 안전이 충분히 확보되는 것은 아니다.", note: "反驳以年龄替代能力评价。" },
    { pattern: "N에 머물지 않고 ... 데 두다", meaning: "不止于……，而把重点放在……", example: "목표는 면허를 회수하는 데 머물지 않고 이동권을 보장하는 데 두어야 한다.", note: "用于提出更完整的政策目标。" },
  ],
  quiz: [
    { question: "文章认为自愿交还驾照政策有什么积极作用？", answer: "它能引导驾驶能力下降的人停止驾驶，降低事故风险并保护驾驶者与行人，在公共交通完善地区也能促成更安全的出行方式转换。" },
    { question: "为什么只按年龄推动交还驾照可能存在问题？", answer: "同龄人的健康和驾驶习惯不同，年龄不能完全代表能力；偏远地区缺少替代交通，停止驾驶还可能损害生活便利和个人自主性。" },
    { question: "作者建议如何同时保障安全与移动权？", answer: "定期检查视力、认知和实际驾驶能力，对部分驾驶者实行条件式驾照，并为停止驾驶者持续提供按需公交、出租车补助和就医陪同服务。" },
  ],
  writingDrill: {
    type: "54 题观点写作",
    prompt:
      "고령 운전자 면허 반납 정책이 교통 안전과 이동권에 미치는 영향에 대해 쓰십시오. 사고 위험 감소라는 장점, 연령 기준의 한계와 대체 교통 부족 문제를 모두 언급하고, 효과적인 운영 방안을 두 가지 이상 제시하십시오.",
    checklist: ["고령 운전자", "면허 반납", "운전 능력", "조건부 면허", "이동권"],
    sentenceBank: [
      "면허 반납 정책은 운전 능력이 낮아진 사람의 사고 위험을 줄이는 데 도움이 될 수 있다.",
      "그러나 나이만을 기준으로 판단하거나 대체 교통을 제공하지 않으면 고령자의 이동권이 약해질 수 있다.",
      "따라서 실제 운전 능력을 점검하고 지역 상황에 맞는 지속적인 이동 서비스를 마련해야 한다.",
    ],
  },
};

const todayReading: DailyReading = {
  id: "2026-09-25-dynamic-pricing-fairness",
  date: "2026-09-25",
  title: "동적 가격제는 소비자에게 공정한가",
  level: "TOPIK II 5-6级",
  topic: "经济 / 科技",
  estimatedTime: "20 分钟",
  korean:
    "온라인 플랫폼과 인공지능 기술이 발달하면서 같은 상품이나 서비스의 가격을 수요와 시간에 따라 실시간으로 바꾸는 동적 가격제가 확산되고 있다. 택시 호출이 몰리는 시간에 요금을 올리거나 공연 좌석의 판매 속도에 따라 가격을 조정하는 방식이 대표적이다. 기업은 한정된 자원을 효율적으로 배분하고 수요가 낮은 시간대에는 할인으로 소비를 유도할 수 있다. 소비자도 이용 시간을 조절할 수 있다면 더 저렴한 가격을 선택할 기회를 얻는다. 그러나 가격이 시장 상황에 따라 달라진다는 사실만으로 거래가 공정해지는 것은 아니다. 어떤 정보가 가격 결정에 사용되는지 알기 어렵고, 소비자마다 검색 기록이나 구매 가능성을 분석해 서로 다른 가격을 제시한다면 같은 조건에서 같은 대우를 받는다는 원칙이 흔들릴 수 있다. 병원 이동이나 귀가처럼 이용을 미루기 어려운 서비스의 가격이 긴급한 순간에 크게 오르면, 지불 능력이 낮은 사람은 필요한 서비스에서 배제될 수도 있다. 가격 변동의 폭과 기준이 공개되지 않으면 소비자는 현재 가격이 합리적인지 판단하기 어렵고, 급하게 결제해야 한다는 압박을 받을 가능성도 있다. 따라서 동적 가격제의 문제는 가격이 변한다는 데 있기보다 누가 어떤 기준으로 위험과 이익을 부담하는지에 있다. 플랫폼은 가격이 오르는 이유와 예상 지속 시간을 결제 전에 명확히 알려야 하며, 개인의 민감한 정보나 취약한 상황을 이용해 가격을 차별하지 못하도록 해야 한다. 정부는 교통과 필수 생활 서비스에 가격 상한이나 예외 기준을 마련하고, 알고리즘이 특정 집단에 지속적으로 불리한 결과를 주는지 독립적으로 점검할 필요가 있다. 소비자가 여러 시간대의 가격을 비교하거나 가격 알림을 받을 수 있는 기능도 제공되어야 한다. 결국 동적 가격제가 효율적인 시장 도구로 인정받으려면 기업의 수익을 높이는 기술을 넘어 소비자가 가격 형성 과정을 이해하고 선택할 수 있는 제도가 되어야 한다.",
  chinese:
    "随着网络平台和人工智能技术发展，根据需求和时间实时改变同一商品或服务价格的动态定价正在扩散。打车需求集中的时段提高费用，或根据演出座位销售速度调整价格，都是典型方式。企业可以更有效地分配有限资源，并在需求较低的时段用折扣引导消费；消费者若能调整使用时间，也有机会选择更低价格。然而，价格会随市场变化，并不意味着交易自然变得公平。如果人们无法知道哪些信息被用于定价，平台又根据每位消费者的搜索记录或购买可能性给出不同价格，那么相同条件下得到相同对待的原则就可能动摇。就医出行、夜间回家等难以推迟的服务若在紧急时刻大幅涨价，支付能力较弱的人甚至可能被排除在必要服务之外。如果价格波动幅度和标准不公开，消费者就难以判断当前价格是否合理，也可能承受必须赶快付款的压力。因此，动态定价的问题不只在于价格变化，而在于谁依据什么标准承担风险、获得利益。平台应在付款前明确说明涨价原因和预计持续时间，也不能利用个人敏感信息或脆弱处境进行价格歧视。政府应对交通和基本生活服务设定价格上限或例外标准，并独立检查算法是否持续对特定群体产生不利结果。还应提供不同时段价格比较和价格提醒功能。归根结底，动态定价若要被认可为高效的市场工具，就必须超越提高企业收益的技术，成为消费者能够理解价格形成过程并作出选择的制度。",
  tokens: [
    { korean: "동적 가격제", reading: "dong-jeok ga-gyeok-je", meaning: "动态定价制", grammar: "명사구", note: "文章核心制度。" },
    { korean: "실시간으로 바꾸다", reading: "sil-si-ga-neu-ro ba-kku-da", meaning: "实时改变", grammar: "동사구", note: "动态定价的技术特征。" },
    { korean: "요금을 올리다", reading: "yo-geu-meul ol-li-da", meaning: "提高费用", grammar: "동사구", note: "需求增加时的价格调整。" },
    { korean: "자원을 배분하다", reading: "ja-wo-neul bae-bun-ha-da", meaning: "分配资源", grammar: "동사구", note: "企业主张的效率价值。" },
    { korean: "소비를 유도하다", reading: "so-bi-reul yu-do-ha-da", meaning: "引导消费", grammar: "동사구", note: "低需求时段折扣的目的。" },
    { korean: "구매 가능성", reading: "gu-mae ga-neung-seong", meaning: "购买可能性", grammar: "명사구", note: "个性化定价可能使用的数据。" },
    { korean: "원칙이 흔들리다", reading: "won-chi-gi heun-deul-li-da", meaning: "原则受到动摇", grammar: "동사구", note: "表达公平性风险。" },
    { korean: "지불 능력", reading: "ji-bul neung-nyeok", meaning: "支付能力", grammar: "명사구", note: "服务可及性的经济条件。" },
    { korean: "가격 변동의 폭", reading: "ga-gyeok byeon-dong-ui pok", meaning: "价格波动幅度", grammar: "명사구", note: "需要公开的信息之一。" },
    { korean: "결제 압박", reading: "gyeol-je ap-bak", meaning: "付款压力", grammar: "명사구", note: "不透明定价影响消费者判断。" },
    { korean: "가격을 차별하다", reading: "ga-gyeo-geul cha-byeol-ha-da", meaning: "实行价格歧视", grammar: "동사구", note: "算法治理的限制对象。" },
    { korean: "가격 상한", reading: "ga-gyeok sang-han", meaning: "价格上限", grammar: "명사구", note: "基本服务的监管工具。" },
    { korean: "가격 형성 과정", reading: "ga-gyeok hyeong-seong gwa-jeong", meaning: "价格形成过程", grammar: "명사구", note: "消费者知情与选择的基础。" },
  ],
  grammarPoints: [
    { pattern: "V-(으)면서", meaning: "随着……", example: "인공지능 기술이 발달하면서 동적 가격제가 확산되고 있다.", note: "引出技术变化带来的市场趋势。" },
    { pattern: "V-(으)ㄹ 수 있다면", meaning: "如果能够……", example: "이용 시간을 조절할 수 있다면 더 저렴한 가격을 선택할 수 있다.", note: "提出消费者获益的条件。" },
    { pattern: "V-다는 사실만으로 ... 것은 아니다", meaning: "仅凭……这一事实并不……", example: "가격이 달라진다는 사실만으로 거래가 공정해지는 것은 아니다.", note: "反驳市场变化天然公平的观点。" },
    { pattern: "N에 있기보다 ... 데 있다", meaning: "与其说在于……，不如说在于……", example: "문제는 가격이 변한다는 데 있기보다 위험과 이익의 부담 기준에 있다.", note: "用于重新界定议题核心。" },
  ],
  quiz: [
    { question: "文章认为动态定价可以带来哪些好处？", answer: "企业可以提高有限资源的分配效率，在低需求时段以折扣引导消费；能调整时间的消费者也可能获得更低价格。" },
    { question: "动态定价为什么可能损害消费者公平？", answer: "定价数据和标准可能不透明，个性化价格会破坏同等条件同等对待，必要服务在紧急时涨价还可能排除支付能力较弱的人。" },
    { question: "作者提出了哪些监管和产品措施？", answer: "平台应说明涨价原因和持续时间，禁止利用敏感信息歧视定价；政府应为必要服务设置上限并审查算法，同时提供跨时段比价和提醒功能。" },
  ],
  writingDrill: {
    type: "54 题观点写作",
    prompt:
      "동적 가격제가 시장과 소비자에게 미치는 영향에 대해 쓰십시오. 자원 배분과 할인 기회라는 장점, 가격 차별과 필수 서비스 접근성 문제를 모두 언급하고, 공정한 운영을 위한 방안을 두 가지 이상 제시하십시오.",
    checklist: ["동적 가격제", "자원 배분", "가격 차별", "가격 상한", "알고리즘 투명성"],
    sentenceBank: [
      "동적 가격제는 수요에 따라 자원을 효율적으로 배분하고 한산한 시간의 소비를 유도할 수 있다.",
      "그러나 가격 결정 기준이 공개되지 않으면 소비자는 차별을 받는지 판단하기 어렵다.",
      "따라서 플랫폼은 가격 형성 정보를 제공하고 정부는 필수 서비스의 상한과 알고리즘 점검 기준을 마련해야 한다.",
    ],
  },
};
